...
- **Optimize**: Discuss time/Space Complexity (Memory usage of the algorithm)
...
- **Optimization**: Achieve optimal Time Complexity (Speed of the algorithm) for 8+ problems
...
**Key Insight**: Cutting off unnecessary steps prevents generating invalid strings
...
- How do you build the Formula that defines a step based on previous steps?
...
**What to think about:**
- Brute Force (Checking every single possibility): check all substrings (too slow)
...
- **9-10 points**: Optimal time/Space Complexity (Memory usage of the algorithm) achieved for 9-10 problems
...
- **9-10 points**: Clean, bug-free code with proper Edge Case (Unusual or extreme situation) handling
...
- [ ] Is this the optimal Time Complexity (Speed of the algorithm)?
...
2. Second attempt: Optimize Time Complexity (Speed of the algorithm)
3. Third attempt: Optimize Space Complexity (Memory usage of the algorithm)
...
- 10: Best possible solution, no bugs, within time
- 8: Best possible solution, minor bugs or slightly over time
...
- Key: Cutting off unnecessary steps and state management
...
- Key: State definition and Formula that defines a step based on previous steps
