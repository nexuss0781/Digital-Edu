...
- Careful Edge Case (Unusual or extreme situation) analysis
- Optimal time/Space Complexity (Memory usage of the algorithm)
...
- **Multiple approaches**: Discuss Brute Force (Checking every single possibility), then optimize
- **Trade-offs**: Explain time/Space Complexity (Memory usage of the algorithm) trade-offs

### Target Performance
- **Total time**: 240-360 minutes (30-45 min per problem)
- **Success rate**: 5-8 problems solved correctly
- **Optimization**: Achieve optimal or near-Best possible solution for 6+ problems
...
**What to think about:**
- Brute Force (Checking every single possibility): Merge arrays O(m+n) - can we do better?
- Binary search on which array?
- What Rule that never changes can we maintain?
...
**What to think about:**
- Brute Force (Checking every single possibility): Merge two at a time - what's the complexity?
...
- **ID**: H002
- **Estimated Time**: 45 minutes
- **Pattern**: 2D DP or recursion with Memoization (Saving results to avoid repeating work)
- **Difficulty**: Very Hard
...
- **7-8 points**: Near-Best possible solution, understood complexity
...
**Algorithm Design:**
- [ ] Identified Brute Force (Checking every single possibility) approach
- [ ] Explained why Brute Force (Checking every single possibility) won't work
...
**Complexity Analysis:**
- [ ] Calculated Time Complexity (Speed of the algorithm) with proof
- [ ] Calculated Space Complexity (Memory usage of the algorithm)
...
- Solve Brute Force (Checking every single possibility) first
...
- **27-30**: Best possible solution, clean code, within time
- **21-26**: Working Best possible solution, minor issues or overtime
...
4. Implement Best possible solution
...
- [ ] Proficient with backtracking and Cutting off unnecessary steps
- [ ] Understand binary search variations
- [ ] Can use heaps effectively

### Problem-Solving Process
- [ ] Can explain Brute Force (Checking every single possibility) approach
- [ ] Identify optimization opportunities
- [ ] Prove correctness of solution
- [ ] Analyze time/Space Complexity (Memory usage of the algorithm)
