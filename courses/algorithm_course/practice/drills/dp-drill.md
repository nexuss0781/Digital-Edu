...
- Choose between Memoization (Saving results to avoid repeating work) and Tabulation (Building a table of results from the bottom up) approaches
- Optimize Space Complexity (Memory usage of the algorithm) from O(n²) to O(n) or O(1)
...
## Memoization (Saving results to avoid repeating work) vs. Tabulation (Building a table of results from the bottom up) Comparison

### Memoization (Saving results to avoid repeating work) (Top-Down)
```
...
### Tabulation (Building a table of results from the bottom up) (Bottom-Up)
```
...
- **Concepts**: Base cases, Formula that defines a step based on previous steps
- **Time Target**: 10 minutes
- **Key Insight**: `dp[i] = dp[i-1] + dp[i-2]`

**Why start here:**
- Simplest DP pattern
- Clear Formula that defines a step based on previous steps
...
4. Derive Formula that defines a step based on previous steps: How to build from smaller problems
...
### 3. Wrong Direction in Tabulation (Building a table of results from the bottom up)
```python
...
### 4. Not Copying in Memoization (Saving results to avoid repeating work)
```python
...
### Implementation
- [ ] Comfortable with both Memoization (Saving results to avoid repeating work) and Tabulation (Building a table of results from the bottom up)
- [ ] Can implement 1D DP in < 10 minutes
- [ ] Can implement 2D DP in < 20 minutes
- [ ] Can optimize Space Complexity (Memory usage of the algorithm)
