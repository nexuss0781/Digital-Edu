...
4. Can this problem be solved with Memoization (Saving results to avoid repeating work)? What would the state be?
...
<details>
<summary>📝 Hint 3: Detailed 2D DP Step-by-step plan in plain English</summary>
...
- [ ] Can derive the Formula that defines a step based on previous steps
