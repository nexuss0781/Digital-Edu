...
When calculating the path that can be extended upward, ignore negative contributions from child paths (use max(0, child_path)). This handles negative values elegantly without separate Edge Case (Unusual or extreme situation) logic.
</details>
