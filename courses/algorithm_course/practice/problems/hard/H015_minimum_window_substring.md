...
**Approach 1: Brute Force (Checking every single possibility) - check all substrings**
```
...
<details>
<summary>📝 Hint 3: Sliding window Step-by-step plan in plain English</summary>
...
|----------|------|-------|-------|
| Brute Force (Checking every single possibility) (all substrings) | O(n² × m) | O(1) | Check each substring |
