...
|----------|------|-------|-------|
| Brute Force (Checking every single possibility) (sort) | O(n log n) | O(1) | Standard sorting then linear scan |
| Bucket Sort | O(n) | O(n) | Linear Time (Time grows directly with data) with n buckets |
