...
You can solve this iteratively by traversing down the right spine until you find the insertion point. Keep track of the parent. This avoids recursion overhead while maintaining O(h) Time Complexity (Speed of the algorithm) where h is the height of the tree.
</details>
