...
Use bidirectional BFS for finding paths to reduce the search space. For very large grids, A* search with Manhattan distance Practical rule of thumb can be faster. However, for the given constraints (m, n ≤ 50), standard BFS is sufficient and simpler to implement correctly.
</details>
