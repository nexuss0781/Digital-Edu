...
|----------|------|-------|-------|
| Brute Force (Checking every single possibility) (Generate All Digits) | O(∞) | O(∞) | May never terminate for repeating decimals |
...
- [ ] Can discuss time/Space Complexity (Memory usage of the algorithm) (O(d) time and space where d is denominator)
