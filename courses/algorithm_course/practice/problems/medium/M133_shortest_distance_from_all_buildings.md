...
| Cutting off unnecessary steps with Markers | O(b×m×n) | O(m×n) | Optimization to skip unreachable cells |
...
- [ ] Day 7: Compare Time Complexity (Speed of the algorithm) of both approaches
- [ ] Day 14: Speed test - solve in 25 minutes
- [ ] Day 30: Solve with Cutting off unnecessary steps optimizations
