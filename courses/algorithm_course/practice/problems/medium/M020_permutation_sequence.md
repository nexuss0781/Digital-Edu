...
This appears in interviews because it tests mathematical thinking rather than just coding. Companies want to see if you can recognize factorial structure, avoid Brute Force (Checking every single possibility) when analytical solutions exist, and handle edge cases like 0-indexed vs 1-indexed conversions and the minimum integer overflow issue with n = -2³¹.
