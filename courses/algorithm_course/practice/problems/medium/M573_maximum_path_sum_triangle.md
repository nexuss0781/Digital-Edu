...
|----------|------|-------|-----------|
| Brute Force (Checking every single possibility) (try all paths) | O(2^n) | O(n) | Exponential - too slow |
...
**Time Complexity (Speed of the algorithm) breakdown:**
```
Row 0: 1 element
Row 1: 2 elements
Row 2: 3 elements
...
```python
# WRONG: Top-down without proper Memoization (Saving results to avoid repeating work) structure
