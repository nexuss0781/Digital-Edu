...
|----------|------|-------|-------|
| Brute Force (Checking every single possibility) | O(n³) | O(1) | Check all substrings with frequency counting |
