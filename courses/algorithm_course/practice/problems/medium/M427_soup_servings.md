...
|----------|------|-------|-------|
| Naive Recursion | O(4^n) | O(n²) | Exponential without Memoization (Saving results to avoid repeating work) |
| DP with Memoization (Saving results to avoid repeating work) | O(n²) | O(n²) | After scaling by 25: O((n/25)²) |
...
---
**Strategy Reference:** [Dynamic Programming - Memoization (Saving results to avoid repeating work)](../../strategies/patterns/dynamic-programming.md)
