...
Edge Case (Unusual or extreme situation): "1+-2i" has real=1, imaginary=-2
...
| Regular expression | O(1) | O(1) | Regex parsing adds overhead but still Constant Time (Same time regardless of data size) |
