...
|----------|------|-------|-------|
| Recursion + Memoization (Saving results to avoid repeating work) | O(n²) | O(n²) | Top-down approach |
| 2D DP | O(n²) | O(n²) | Standard Tabulation (Building a table of results from the bottom up) |
