...
| Brute Force (Checking every single possibility) Generation | O(10^k) | O(1) | k is number of digits in result; highly inefficient |
...
- [ ] Handle Edge Case (Unusual or extreme situation): num == 1
- [ ] Handle Edge Case (Unusual or extreme situation): num is prime (2-9)
- [ ] Handle Edge Case (Unusual or extreme situation): num has large prime factors (return 0)
