...
How many elements can possibly appear more than ⌊n/3⌋ times? Think about it: if an element appears more than n/3 times, at most how many such elements can exist? This mathematical constraint is key to an Best possible solution.
...
- [ ] Verify O(1) Space Complexity (Memory usage of the algorithm)
