...
|----------|------|-------|-------|
| Brute Force (Checking every single possibility) (Simulation) | O(n²) | O(n) | Repeatedly scan tree to find/remove leaves |
...
| Binary tree Cutting off unnecessary steps | Remove subtrees based on condition | Similar DFS but with conditional removal |
