...
|-----------|-------------|----------------|
| Bulb Switcher II | Limited toggles with different patterns | Use bit manipulation and Memoization (Saving results to avoid repeating work) |
