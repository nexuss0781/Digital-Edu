...
<details>
<summary>Hint 1: Brute Force (Checking every single possibility) and Preprocessing Tradeoff</summary>
...
| Approach | Time Complexity (Speed of the algorithm) (Query) | Time Complexity (Speed of the algorithm) (Build) | Space Complexity (Memory usage of the algorithm) | Notes |
|----------|------------------------|------------------------|------------------|-------|
| Brute Force (Checking every single possibility) | O(n * m) | O(1) | O(n * m) | Check every word |
