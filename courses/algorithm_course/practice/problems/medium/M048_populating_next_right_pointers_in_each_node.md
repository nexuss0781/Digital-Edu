...
- [ ] Handles empty tree Edge Case (Unusual or extreme situation)
- [ ] Can explain O(1) space approach in 2 min
- [ ] Can code Best possible solution in 15 min
- [ ] Can discuss time/Space Complexity (Memory usage of the algorithm) tradeoffs
