...
Step-by-step plan in plain English for DFS approach:
...
|----------|------|-------|-------|
| Brute Force (Checking every single possibility) | O(n! × m) | O(n) | Try all course orderings, check validity. Exponential complexity |
