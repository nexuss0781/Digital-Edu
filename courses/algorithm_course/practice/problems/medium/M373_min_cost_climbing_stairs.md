...
<details>
<summary>Hint 2: Formula that defines a step based on previous steps</summary>
...
This reduces Space Complexity (Memory usage of the algorithm) from O(n) to O(1).
