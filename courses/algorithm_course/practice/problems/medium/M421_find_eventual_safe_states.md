...
|----------|------|-------|-------|
| DFS with Memoization (Saving results to avoid repeating work) | O(V + E) | O(V) | V = nodes, E = edges, visit each node/edge once |
