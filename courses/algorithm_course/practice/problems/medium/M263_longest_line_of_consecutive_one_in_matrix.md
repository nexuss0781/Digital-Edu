...
| Brute Force (Checking every single possibility) | O(m² * n²) | O(1) | Check all starting positions and directions |
...
- [ ] Handle Edge Case (Unusual or extreme situation): all zeros
- [ ] Handle Edge Case (Unusual or extreme situation): all ones
- [ ] Handle Edge Case (Unusual or extreme situation): single row or column
