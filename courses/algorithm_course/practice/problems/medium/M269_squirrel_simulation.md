...
| Brute Force (Checking every single possibility) | O(n²) | O(1) | Try each nut as first choice; unnecessary |
...
- [ ] Handle Edge Case (Unusual or extreme situation): single nut (Day 2)
