...
- [ ] Verify Time Complexity (Speed of the algorithm) improvement over O(n)

**Spaced Repetition Schedule:**
- Day 1: Initial attempt, understand complete tree property
- Day 3: Implement without hints
- Day 7: Optimize and explain Time Complexity (Speed of the algorithm)
