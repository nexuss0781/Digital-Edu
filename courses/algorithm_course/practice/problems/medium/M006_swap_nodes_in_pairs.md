...
**Why iterative wins:**
- O(1) Space Complexity (Memory usage of the algorithm) (no recursion overhead)
...
**Edge Case (Unusual or extreme situation): Odd number of nodes**
```
Input: 1 → 2 → 3 → NULL
