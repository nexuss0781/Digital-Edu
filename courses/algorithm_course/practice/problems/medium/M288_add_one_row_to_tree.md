...
- [ ] Handle Edge Case (Unusual or extreme situation): depth == 1 (new root)
- [ ] Handle Edge Case (Unusual or extreme situation): single node tree
- [ ] Handle Edge Case (Unusual or extreme situation): depth equals tree height + 1
