...
Think about traversing the tree level by level. How can you ensure you're visiting all nodes at each depth? BFS (Breadth-First Search) naturally processes nodes level by level. What data structure supports FIFO (First-In-First-Out, like a line at a store) ordering?
