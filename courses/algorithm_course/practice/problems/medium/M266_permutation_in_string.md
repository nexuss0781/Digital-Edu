...
| Brute Force (Checking every single possibility) | O(n * m * m!) | O(m) | Generate all permutations of s1 |
...
- [ ] Handle Edge Case (Unusual or extreme situation): s1 longer than s2
- [ ] Handle Edge Case (Unusual or extreme situation): s1 and s2 are identical
