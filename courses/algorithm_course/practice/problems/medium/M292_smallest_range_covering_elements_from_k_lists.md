...
| Brute Force (Checking every single possibility) (Try All) | O(n^k) | O(1) | Try all combinations of one element per list |
...
- [ ] **Review in 2 weeks**: Optimize Space Complexity (Memory usage of the algorithm)
