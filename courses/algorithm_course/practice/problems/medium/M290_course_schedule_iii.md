...
| Brute Force (Checking every single possibility) | O(n! * n) | O(n) | Try all permutations and check validity |
...
- [ ] Test Edge Case (Unusual or extreme situation): all courses have same deadline
- [ ] Test Edge Case (Unusual or extreme situation): impossible to take any course
