...
|----------|------|-------|-----------|
| **Three-phase scan** | **O(n)** | **O(n)** | Optimal, Linear Time (Time grows directly with data) |
...
**Edge Case (Unusual or extreme situation): newInterval covers all**
```
...
**Edge Case (Unusual or extreme situation): No overlaps**
```
