...
|----------|------|-------|-------|
| Brute Force (Checking every single possibility) | O(n^4) | O(1) | Try all (2n-1)^2 shifts, check n^2 cells each |
