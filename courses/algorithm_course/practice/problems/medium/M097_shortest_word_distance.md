...
|----------|------|-------|-------|
| Brute Force (Checking every single possibility) | O(n²) | O(n) | Store all indices, compare all pairs |
...
- [ ] Handle Edge Case (Unusual or extreme situation) with only two words total
