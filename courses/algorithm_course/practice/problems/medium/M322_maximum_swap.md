...
|----------|----------------|------------------|-------|
| Greedy with Last Index | O(n) | O(n) | n = number of digits; Best possible solution |
| Brute Force (Checking every single possibility) (all swaps) | O(n²) | O(n) | Try all possible swaps |
