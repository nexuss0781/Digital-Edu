...
|----------|------|-------|-------|
| Recursive DFS | O(10 × 3ⁿ) | O(n) | Without Memoization (Saving results to avoid repeating work), exponential |
...
3. **Not handling n=1 Edge Case (Unusual or extreme situation)**
   ```python
   # Wrong: Assumes n > 1
