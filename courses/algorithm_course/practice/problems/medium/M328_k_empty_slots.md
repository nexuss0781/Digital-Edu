...
|----------|----------------|------------------|-------|
| Brute Force (Checking every single possibility) Simulation | O(n²) | O(n) | Simulate each day and check all windows |
...
- [ ] **Optimize**: Achieve O(n) Time Complexity (Speed of the algorithm)
