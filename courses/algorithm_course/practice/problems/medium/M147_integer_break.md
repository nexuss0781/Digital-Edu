...
|----------|------|-------|-------|
| Brute Force (Checking every single possibility) Recursion | O(2^n) | O(n) | Try all partitions, exponential |
...
- [ ] Handle Edge Case (Unusual or extreme situation): n = 2
- [ ] Handle Edge Case (Unusual or extreme situation): n = 3
