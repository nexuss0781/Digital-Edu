...
function combinationSum2(candidates, target):
    ...
    function backtrack(start, remaining):
        ...
        if remaining < 0:
            return  # Cutting off unnecessary steps: exceeded target
        ...
        for i from start to end:
            ...
            # Cutting off unnecessary steps: sorted array, so no point continuing
...
| DFS without Cutting off unnecessary steps | O(2^n × n) | O(n) | Explores unnecessary branches |

**Why backtracking with skip wins:**
- Generates only unique combinations (no deduplication needed)
- Cutting off unnecessary steps reduces branches significantly
...
**Cutting off unnecessary steps effectiveness:**
...
### 5. Not Cutting off unnecessary steps with sorted array
```python
...
- [ ] Proper Cutting off unnecessary steps with break
- [ ] Clear variable names

**Optimization:**
- [ ] O(2^n) time without unnecessary deduplication
- [ ] Early termination with Cutting off unnecessary steps
