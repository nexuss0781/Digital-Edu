...
|----------|------|-------|-------|
| Recursive DFS | O(2^n) | O(n) | Without Memoization (Saving results to avoid repeating work) |
| DP (Memoization (Saving results to avoid repeating work)) | O(n^2) | O(n^2) | Top-down with cache |
| DP (Tabulation (Building a table of results from the bottom up)) | O(n^2) | O(n^2) | Bottom-up, can optimize to O(n) |
