...
|----------|------|-------|-------|
| Brute Force (Checking every single possibility) (All Combinations) | O(2^n) | O(n) | Try all possible buy/sell combinations |
