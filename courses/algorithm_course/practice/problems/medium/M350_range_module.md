...
The key insight: keep intervals sorted and non-overlapping. After each operation, merge adjacent/overlapping intervals to maintain this Rule that never changes.
</details>
