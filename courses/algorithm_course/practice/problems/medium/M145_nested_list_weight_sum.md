...
- [ ] Handle Edge Case (Unusual or extreme situation): empty nested list
- [ ] Handle Edge Case (Unusual or extreme situation): single integer (no nesting)
- [ ] Handle Edge Case (Unusual or extreme situation): deeply nested (depth 50)
- [ ] Handle Edge Case (Unusual or extreme situation): negative integers
