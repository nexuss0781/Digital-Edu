...
|----------|------|-------|-------|
| Brute Force (Checking every single possibility) (Try all) | O(k^n) | O(n) | Exponential, impractical |
...
### Mistake 2: Incorrect Formula that defines a step based on previous steps
```python
