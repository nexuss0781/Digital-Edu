...
|----------|------|-------|-------|
| Brute Force (Checking every single possibility) Simulation | O(n) | O(n) | TLE for large n, stores entire array |
