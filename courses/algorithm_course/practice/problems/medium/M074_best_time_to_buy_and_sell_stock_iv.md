...
|----------|------|-------|-------|
| Brute Force (Checking every single possibility) (All Combinations) | O(n^k) | O(1) | Exponential - infeasible |
...
- [ ] Can discuss time/Space Complexity (Memory usage of the algorithm) and optimization for large k
