...
prerequisites: ["minimax-algorithm", "2d-dp", "game-theory", "Memoization (Saving results to avoid repeating work)"]
---
...
|----------|------|-------|-------|
| Recursive Brute Force (Checking every single possibility) | O(n!) | O(n) | Exponential due to trying all guess sequences |
| Memoization (Saving results to avoid repeating work) (Top-Down DP) | O(n³) | O(n²) | Cache results for each range |
