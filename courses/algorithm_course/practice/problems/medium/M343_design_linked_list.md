...
| Approach | Operation | Time Complexity (Speed of the algorithm) | Space Complexity (Memory usage of the algorithm) | Notes |
|----------|-----------|----------------|------------------|-------|
...
- [ ] Analyzed time/Space Complexity (Memory usage of the algorithm) for each operation
