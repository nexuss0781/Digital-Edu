...
<details>
<summary>💡 Hint 1: Edge Case (Unusual or extreme situation) Handling</summary>
...
|----------|------|-------|-------|
| Brute Force (Checking every single possibility) | O(n²) | O(1) | Find all occurrences, compare all pairs |
...
- [ ] Can explain the Edge Case (Unusual or extreme situation) handling (Day 14)
