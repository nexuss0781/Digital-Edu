...
|----------|----------------|------------------|-------|
| Brute Force (Checking every single possibility) (check all pairs) | O(n^2) | O(1) | Compare max with every element |
...
### Mistake 2: Not Handling Edge Case (Unusual or extreme situation) with Index Update
```python
