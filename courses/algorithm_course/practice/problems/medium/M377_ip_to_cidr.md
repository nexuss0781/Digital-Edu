...
|----------|----------------|------------------|-------|
| Brute Force (Checking every single possibility) (list all IPs) | O(n) | O(n) | Store every IP individually |
...
### Mistake 3: Edge Case (Unusual or extreme situation) with Alignment = 0
```python
