...
The Formula that defines a step based on previous steps is:
...
|----------|----------------|------------------|-------|
| Brute Force (Checking every single possibility) (try all combinations) | O(2^n) | O(n) | Exponential - not practical |
