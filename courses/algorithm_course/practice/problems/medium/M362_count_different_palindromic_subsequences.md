...
Use precomputation or Memoization (Saving results to avoid repeating work) to track character positions efficiently.
...
| Memoized recursion | O(n²) | O(n²) | Recursion with Memoization (Saving results to avoid repeating work), similar to DP |
