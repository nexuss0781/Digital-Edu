...
- [ ] Handle Edge Case (Unusual or extreme situation): empty list
- [ ] Handle Edge Case (Unusual or extreme situation): single node
- [ ] Handle Edge Case (Unusual or extreme situation): two nodes
- [ ] Test with odd-length list (5 nodes)
- [ ] Test with even-length list (6 nodes)
- [ ] Verify no memory leaks or cycles
- [ ] Confirm O(1) Space Complexity (Memory usage of the algorithm)
- [ ] Confirm O(n) Time Complexity (Speed of the algorithm)
