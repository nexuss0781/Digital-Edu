...
Learning to identify when a problem needs Union-Find versus DFS/BFS is a valuable algorithmic skill. Union-Find provides near-Constant Time (Same time regardless of data size) operations for connectivity queries, making it ideal for this problem.
