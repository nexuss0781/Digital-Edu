...
1. **Avoid Brute Force (Checking every single possibility)**: Building the entire n×n matrix is O(n²) space and time. Recognizing the pattern makes it O(n) time and O(1) space.
