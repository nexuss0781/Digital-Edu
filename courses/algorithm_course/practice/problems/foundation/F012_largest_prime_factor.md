...
The O(√n) Time Complexity (Speed of the algorithm) demonstrates that you don't need to factor a number completely to answer questions about it—you only need to check up to the square root.
