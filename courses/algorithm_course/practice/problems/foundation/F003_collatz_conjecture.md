...
- Memoization (Saving results to avoid repeating work) for optimization
...
<details>
<summary>Hint 2: Optimization with Memoization (Saving results to avoid repeating work)</summary>
...
5. **Inefficient multiple queries**: If computing stopping time for many values, use Memoization (Saving results to avoid repeating work). The sequences overlap significantly.
...
|-----------|--------|---------------------|
| Longest sequence under N | Find starting value with max stopping time | Iterate 1 to N-1 with Memoization (Saving results to avoid repeating work) |
...
- [ ] Understands why Memoization (Saving results to avoid repeating work) helps
