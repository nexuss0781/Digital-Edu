...
- **Dynamic programming**: Classic teaching example for Memoization (Saving results to avoid repeating work)
...
You only need to keep track of the last two Fibonacci numbers at any time, not the entire sequence. This gives you O(1) Space Complexity (Memory usage of the algorithm).
