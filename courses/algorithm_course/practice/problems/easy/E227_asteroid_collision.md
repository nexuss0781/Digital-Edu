...
Your task is to determine which asteroids remain after all collisions have occurred. Note that the order of asteroids in your answer matters. Important Edge Case (Unusual or extreme situation): asteroids can trigger chain reactions where one collision leads to another, and then another, until no more collisions are possible.
...
|----------|----------------|------------------|-------|
| Brute Force (Checking every single possibility) (Array) | O(n²) | O(n) | Each asteroid may trigger checking all previous ones |
...
- [ ] Handled Edge Case (Unusual or extreme situation): all asteroids moving same direction
- [ ] Handled Edge Case (Unusual or extreme situation): alternating directions
- [ ] Handled Edge Case (Unusual or extreme situation): chain collisions (3+ asteroids)
- [ ] Handled Edge Case (Unusual or extreme situation): equal mass collisions
