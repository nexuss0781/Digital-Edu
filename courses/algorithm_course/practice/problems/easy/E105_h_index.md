...
Step-by-step plan in plain English (sorting approach):
...
|----------|------|-------|-------|
| Brute Force (Checking every single possibility) (Try All h) | O(n²) | O(1) | For each h, count papers >= h |
