...
- **Edge Case (Unusual or extreme situation) handling**: Dealing with duplicates and missing elements
...
**Brute Force (Checking every single possibility):** Linear scan from left to right is O(n). Can you do better using the sorted property?
