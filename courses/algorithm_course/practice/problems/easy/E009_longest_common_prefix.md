...
- **Edge Case (Unusual or extreme situation) handling**: Empty strings and arrays
...
- [ ] Handles empty array Edge Case (Unusual or extreme situation)
- [ ] Handles array with single string
- [ ] Handles strings of different lengths

**Optimization:**
- [ ] Achieved O(S) Time Complexity (Speed of the algorithm)
