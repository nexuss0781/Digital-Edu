...
def findRelativeRanks(score):
    ...
    return result
```
**Why it's wrong**: This approach has O(n²) Time Complexity (Speed of the algorithm) due to repeated linear searches. Also, it doesn't handle the medal strings correctly.
