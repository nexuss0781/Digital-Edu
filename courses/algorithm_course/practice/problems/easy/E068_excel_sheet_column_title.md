...
Think about: What happens when you convert 26? In regular base-26 with 0-indexed, it would be "10". But Excel expects "Z" (not "AZ"). How do you handle this Edge Case (Unusual or extreme situation)?
...
|----------|------|-------|-------|
| Brute Force (Checking every single possibility) | O(n) | O(n) | Count from 1, generate each title |
