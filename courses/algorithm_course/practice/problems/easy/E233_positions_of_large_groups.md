...
- [ ] Handled Edge Case (Unusual or extreme situation): last group is large
- [ ] Handled Edge Case (Unusual or extreme situation): entire string is one large group
- [ ] Handled Edge Case (Unusual or extreme situation): no large groups exist
- [ ] Handled Edge Case (Unusual or extreme situation): multiple large groups back-to-back
