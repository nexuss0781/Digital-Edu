...
This allows O(n) Time Complexity (Speed of the algorithm) instead of O(n log n).
...
| Brute Force (Checking every single possibility) | O(n³) | O(1) | Check all triplets; impractical |
