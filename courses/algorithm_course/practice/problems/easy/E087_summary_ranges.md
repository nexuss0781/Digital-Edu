...
1. Handle empty array Edge Case (Unusual or extreme situation)
...
|----------|------|-------|-------|
| Brute Force (Checking every single possibility) (Nested Loop) | O(n²) | O(n) | Check every pair - unnecessarily slow |
