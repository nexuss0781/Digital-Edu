...
### Beginner Approach - Brute Force (Checking every single possibility) Triple Loop
...
**Trade-off**: Better than O(n^3), easier to implement than Best possible solution.
...
|----------|----------------|------------------|-------|
| Brute Force (Checking every single possibility) (3 loops) | O(n^3) | O(1) | Check all triplets |
...
- [ ] **Day 1**: Solve with Brute Force (Checking every single possibility) O(n^3) approach (allow 20 mins)
