...
- Edge Case (Unusual or extreme situation) when `k = 0` (no duplicates can satisfy this)
...
|----------|------|-------|-------|
| Brute Force (Checking every single possibility) | O(nk) | O(1) | Check k previous elements for each |
