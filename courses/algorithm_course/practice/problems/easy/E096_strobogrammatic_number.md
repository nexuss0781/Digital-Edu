...
|----------|------|-------|-------|
| Brute Force (Checking every single possibility) (Reverse & Compare) | O(n) | O(n) | Build rotated string, compare |
...
### Mistake 3: Middle Character Edge Case (Unusual or extreme situation)
