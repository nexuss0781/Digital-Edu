...
- [ ] Handled Edge Case (Unusual or extreme situation): 1x1 matrix
- [ ] Handled Edge Case (Unusual or extreme situation): single row matrix
- [ ] Handled Edge Case (Unusual or extreme situation): single column matrix
