...
The key insight is that this problem naturally fits a Last-In-First-Out (LIFO (Last-In-First-Out, like a stack of plates)) data structure. You need to frequently access the most recent score (for 'D'), the two most recent scores (for '+'), and remove the most recent score (for 'C'). A stack is perfect for this.
...
Consider what data structure naturally supports adding elements, removing the most recent element, and accessing the last one or two elements. Think about Last-In-First-Out (LIFO (Last-In-First-Out, like a stack of plates)) behavior.
