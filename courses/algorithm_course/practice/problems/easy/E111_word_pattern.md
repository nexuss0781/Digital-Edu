...
|----------|------|-------|-------|
| Brute Force (Checking every single possibility) Matching | O(n * m²) | O(1) | Compare every char-word pair repeatedly |
...
- [ ] Handle Edge Case (Unusual or extreme situation): different lengths (5 min)
