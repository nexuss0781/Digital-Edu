...
|----------|----------------|------------------|-------|
| Greedy (Two Pointers) | O(n) | O(n) | Best possible solution, single pass |
...
**Best possible solution**: Greedy approach with two pointers achieves O(n) Time Complexity (Speed of the algorithm).
