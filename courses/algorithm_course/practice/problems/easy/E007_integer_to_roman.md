...
This problem introduces the greedy algorithm pattern, where making the locally optimal choice at each step (using the largest symbol possible) leads to the globally Best possible solution. Understanding when greedy algorithms work and when they don't is fundamental to algorithm design.
