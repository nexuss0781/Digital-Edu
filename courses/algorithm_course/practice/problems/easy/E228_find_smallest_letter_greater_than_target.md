...
Binary search will help you find the insertion point. But what if all characters are less than or equal to target? The problem says to wrap around to the first element. How can you handle this Edge Case (Unusual or extreme situation) elegantly? Can modulo arithmetic help?
...
- [ ] Handled Edge Case (Unusual or extreme situation): target greater than all letters
- [ ] Handled Edge Case (Unusual or extreme situation): target equals last letter
- [ ] Handled Edge Case (Unusual or extreme situation): all letters are the same
- [ ] Handled Edge Case (Unusual or extreme situation): two-letter array
