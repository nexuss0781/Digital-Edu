...
### Beginner Approach - Brute Force (Checking every single possibility) Nested Loop
...
|----------|----------------|------------------|-------|
| Brute Force (Checking every single possibility) | O(n^2) | O(n) | Check all pairs, result array |
...
- [ ] **Day 1**: Solve with Brute Force (Checking every single possibility) O(n^2) approach (allow 25 mins)
