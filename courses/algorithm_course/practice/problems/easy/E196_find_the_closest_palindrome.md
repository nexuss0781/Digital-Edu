...
| Brute Force (Checking every single possibility) | O(n × 10^k) | O(n) | k = number of digits to change; impractical for large n |
...
**Strategy**: See [Edge Case (Unusual or extreme situation) Analysis](../strategies/patterns/edge-case-analysis.md)
