...
|----------|----------------|------------------|-------|
| Brute Force (Checking every single possibility) (pixel grid) | O(n * A) | O(A) | A = total area, mark each pixel |
