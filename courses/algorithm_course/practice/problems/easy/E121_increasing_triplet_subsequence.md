...
|----------|----------------|------------------|-------|
| Greedy two-variable | O(n) | O(1) | Best possible solution, single pass |
| Brute Force (Checking every single possibility) (3 loops) | O(n^3) | O(1) | Check all triplet combinations |
...
Study Plan:
- [ ] Day 1: Understand subsequence concept, implement Brute Force (Checking every single possibility)
...
- [ ] Day 30: Speed solve (< 10 minutes), explain Rule that never changes
