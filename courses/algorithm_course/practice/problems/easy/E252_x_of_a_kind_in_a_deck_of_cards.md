...
Note: GCD of 0 and any number n is n. Handle this Edge Case (Unusual or extreme situation).
...
| Brute Force (Checking every single possibility) divisors | O(n × m) | O(k) | Check all possible divisors from 2 to max frequency |
