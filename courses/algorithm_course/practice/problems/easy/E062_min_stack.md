...
Design a stack data structure that supports the standard stack operations (push, pop, top) plus one additional operation: retrieving the minimum element in Constant Time (Same time regardless of data size) O(1).
