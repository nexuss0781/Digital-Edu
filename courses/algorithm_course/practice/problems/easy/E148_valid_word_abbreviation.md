...
### Advanced Approach - Single Pass with Edge Case (Unusual or extreme situation) Handling
...
Linear Time (Time grows directly with data) is optimal since we must examine each character at least once.
