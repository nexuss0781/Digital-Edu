...
|----------|----------------|------------------|-------|
| Column-by-Column Check | O(n * m) | O(1) | Best possible solution, n = rows, m = columns |
...
**Best possible solution**: Column-by-column iteration achieves O(n * m) with O(1) space.
