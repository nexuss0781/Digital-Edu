...
### Tier 1: Brute Force (Checking every single possibility)
...
### Tier 2: Optimized
Consider organizing the similar pairs for faster lookup. What data structure allows you to check if a word pair exists in Constant Time (Same time regardless of data size)? How would you structure the data to quickly answer: "Are word A and word B similar?"
...
|----------|----------------|------------------|-------|
| Brute Force (Checking every single possibility) (Linear Search) | O(n * p) | O(1) | Check each word pair against all p similarPairs |
...
- [ ] Handled Edge Case (Unusual or extreme situation): different length sentences
- [ ] Handled Edge Case (Unusual or extreme situation): empty similarPairs
- [ ] Handled Edge Case (Unusual or extreme situation): words similar to themselves
