...
This is a high-frequency interview question that tests your ability to balance time and Space Complexity (Memory usage of the algorithm), choose appropriate data structures (hash map vs. fixed array), and handle edge cases like empty strings or all-duplicate characters. The skills practiced here transfer directly to more complex string manipulation problems.
...
|----------|----------------|------------------|-------|
| Brute Force (Checking every single possibility) (nested loops) | O(n²) | O(1) | Check each character against all others |
...
### Mistake 3: Not handling Edge Case (Unusual or extreme situation)
```python
