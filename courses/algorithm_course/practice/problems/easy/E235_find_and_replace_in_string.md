...
- [ ] Handled Edge Case (Unusual or extreme situation): no valid replacements
- [ ] Handled Edge Case (Unusual or extreme situation): all replacements are invalid
- [ ] Handled Edge Case (Unusual or extreme situation): replacement at start/end of string
- [ ] Handled Edge Case (Unusual or extreme situation): target longer than source
- [ ] Handled Edge Case (Unusual or extreme situation): empty source or target
