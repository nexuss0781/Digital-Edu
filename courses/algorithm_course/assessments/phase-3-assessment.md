...
3. Analyze time and Space Complexity (Memory usage of the algorithm)
...
- Space: O(n)
- Maintain heap size Rule that never changes (sizes differ by at most 1)
...
- Not maintaining heap size Rule that never changes
...
**Common Issues:**
- Not maintaining size Rule that never changes
...
1. **Verify your solution:**
   ...
   - Think of edge cases
   - Verify time/Space Complexity (Memory usage of the algorithm)

2. **For incorrect solutions:**
   - Identify where you went wrong
   - Was it pattern recognition?
   - Implementation detail?
   - Edge Case (Unusual or extreme situation) handling?

3. **Study Best possible solution:**
...
- **DFS + Memoization (Saving results to avoid repeating work):** Dynamic programming on trees
...
- ✓ Code Best possible solution in 10-15 minutes
- ✓ Minimal debugging needed
- ✓ Handle edge cases proactively

### Complexity Analysis (Essential)
- ✓ Correctly analyze Time Complexity (Speed of the algorithm)
- ✓ Correctly analyze Space Complexity (Memory usage of the algorithm)
...
- [ ] Discuss Brute Force (Checking every single possibility) first
