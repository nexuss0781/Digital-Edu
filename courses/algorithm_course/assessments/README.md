...
- [ ] Understand time/Space Complexity (Memory usage of the algorithm)
...
- Edge Case (Unusual or extreme situation) handling affects score
...
- ✓ Optimal Time Complexity (Speed of the algorithm)
- ✓ Optimal Space Complexity (Memory usage of the algorithm)
...
- **Edge Case (Unusual or extreme situation) Coverage:** Do you identify edge cases without prompts?
...
- `/prerequisites/` - Data structures, time/Space Complexity (Memory usage of the algorithm), number theory
