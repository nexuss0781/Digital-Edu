...
| [03 - Low-Level Design](./03-low-level-design.md) | Data models, SDP/ICE protocols, signaling API, congestion control Step-by-step plan in plain English |
...
|---|---|---|
| [1.2 Distributed Load Balancer](../1.2-distributed-load-balancer/) | SFU node selection uses weighted load-based routing similar to L4/L7 balancers | Weighted assignment, health-check-based routing |
| [5.6 Video Streaming Platform](../5.6-video-streaming-platform/) | Shares adaptive bitrate concepts but at different latency tiers (seconds vs milliseconds) | ABR ladder, codec negotiation, CDN edge distribution |
| [11.3 Push Notification System](../11.3-push-notification-system/) | WebSocket-based persistent connection management and fan-out scaling | Connection pooling, message fan-out, presence tracking |
| [11.4 Email Delivery System](../11.4-email-delivery-system/) | TURN relay routing parallels SMTP relay chains; both are store-and-forward with fallback | Relay routing, credential-based authentication |
| [11.5 SMS Gateway](../11.5-sms-gateway/) | Delivery reliability patterns: retry with fallback, provider routing, delivery receipts | Multi-provider failover, delivery confirmation |
| [12.5 CDN Design](../12.5-cdn-design/) | Edge deployment of STUN/TURN mirrors CDN PoP placement strategy | Geo-distributed edge servers, anycast routing |
| [15.1 Distributed Tracing](../15.1-distributed-tracing/) | Call quality tracing across signaling→ICE→DTLS→media mirrors distributed trace spans | Multi-component trace correlation, latency breakdown |
