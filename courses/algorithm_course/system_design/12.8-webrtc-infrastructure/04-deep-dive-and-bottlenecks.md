...
### Critical Edge Case (Unusual or extreme situation): Oort 443 Fallback Chain
...
### Slowest part of the process 1: SFU Port Exhaustion
...
### Slowest part of the process 2: SRTP Encrypt/Decrypt CPU

**Problem:** Every forwarded packet requires SRTP decryption (publisher's keys) and re-encryption (subscriber's keys). At 50,000 packets/second with 1 μs per operation = 100ms of CPU time per second (10% of one core). For a node with 1,500 tracks, this becomes the CPU Slowest part of the process.
...
### Slowest part of the process 3: Keyframe Storms
...
### Slowest part of the process 4: Signaling Server Fan-Out
...
### Slowest part of the process 5: TURN Bandwidth Cost
