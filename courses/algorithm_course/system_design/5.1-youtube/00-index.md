...
| **Streaming Protocol** | DASH, HLS, QUIC/HTTP3, LL-DASH | Adaptive bitrate delivery |
...
| **Transcoding** | Custom ASICs (Argos VCU), FFmpeg | Video encoding (AV1 hardware-accelerated) |
...
|---------|--------|-----------|
| Short-Form Video | [TikTok](../4.5-tiktok/00-index.md) | Recommendation-first discovery, vertical video processing |
| Long-Form Streaming | [Netflix](../5.2-netflix/00-index.md) | Per-title encoding, Open Connect CDN, content-aware ABR |
| Edge Caching | [CDN Design](../1.15-content-delivery-network-cdn/00-index.md) | 3-tier cache hierarchy, ISP peering, origin shielding |
| Object Storage | [Blob Storage](../1.12-blob-storage-system/00-index.md) | Erasure coding, tiered storage, chunked upload |
| ML Personalization | [Recommendation Engine](../3.12-recommendation-engine/00-index.md) | Two-tower models, feature store, ANN retrieval |
| Live Streaming | [Twitch](../5.7-twitch/00-index.md) | SFU cascade, chat fanout, transcoding at ingest |
| Feature Serving | [Feature Store](../3.16-feature-store/00-index.md) | Low-latency feature lookup for real-time inference |
| Content Safety | [AI Guardrails](../3.22-ai-guardrails-safety-system/00-index.md) | Multi-modal moderation, adversarial robustness |

---

## AV1 Hardware Encoding Landscape (2025)

| Platform | Chip Generation | AV1 Encode Support | Density |
|----------|----------------|---------------------|---------|
| **Custom ASICs** | Argos VCU (2021+) | Yes | Replaces ~100 CPU cores for VP9 |
| **NVIDIA** | RTX 50-series (9th-gen NVENC) | Dual AV1 encoders | 2x density vs RTX 40-series |
| **Intel** | Flex series (data center) | Yes | 8 simultaneous 1080p60 streams/card |
| **AMD** | RDNA 4 (RX 9070, 2025) | Improved AV1 blocks | Data center MI300X support |
| **Qualcomm** | Snapdragon 8 Gen 3+ | On-device AV1 encode | Enables mobile AV1 uploads |
| **Apple** | M3+ / A17 Pro | Decode only (no encode) | Safari 17+ AV1 decode |

> **Impact**: Hardware AV1 adoption transforms the codec selection strategy. With 70%+ of YouTube watch time now served as AV1 on supported devices, the earlier "AV1 only for popular videos" Practical rule of thumb is shifting toward "AV1 as default encode" for new hardware-accelerated pipelines.
...
- [SVT-AV1: Open-Source AV1 Encoder (Intel/Netflix)](https://gitlab.com/AOMediaCodec/SVT-AV1)
- [ScaNN: Efficient Vector Similarity Search (Google, ICML 2020)](https://research.google/pubs/pub49040/)
- [Sampling-Bias-Corrected Neural Modeling for Large Corpus Item Recommendations (KDD 2019)](https://research.google/pubs/pub48840/)
- [HyperLogLog in Practice: Algorithmic Engineering of a State-of-the-Art Cardinality Estimation Algorithm (Google, EDBT 2013)](https://research.google/pubs/pub40671/)
- [SynthID: Identifying AI-Generated Content (Google DeepMind, 2024)](https://deepmind.google/technologies/synthid/)
- [C2PA Content Provenance Standard v2.0 (2024)](https://c2pa.org/specifications/)
