...
```
--- Revenue Model ---
Merchant discount fee revenue:    $100B GMV × 4.5% avg rate = $4.5B/year
Late fee revenue:                 ~$675M/year (15% of total revenue)
Interest revenue (Pay-in-12+):    ~$350M/year (from APR-bearing plans)
Total annual revenue:             ~$5.5B

--- Cost Structure ---
Cost of capital (funding):        $4.5B receivables × 5% funding cost = $225M/year
Credit losses (charge-offs):      $100B × 3% default × 70% LGD = $2.1B/year
Payment processor fees:           5M × 365 × $0.25 avg = ~$456M/year
Credit bureau data costs:         3M × 365 × $0.10 = ~$110M/year
Infrastructure + operations:     ~$300M/year

--- Unit Economics Per Plan ---
Average plan value:               $150
Merchant fee earned:              $150 × 4.5% = $6.75
Expected credit loss:             $150 × 3% × 70% = $3.15
Collection cost:                  ~$0.50 (4 payments × $0.125)
Bureau + ML scoring cost:         ~$0.15
Net margin per plan:              ~$2.95 (43.7% contribution margin)

--- Sensitivity Analysis ---
1% improvement in default rate:   +$70M annual margin
1% improvement in collection rate: +$45M annual recovery
0.5% improvement in merchant fee: +$500M annual revenue
100ms reduction in decision latency: +0.5% checkout conversion = +$50M
```
...
United States:           50 states + DC + territories
  - Lending license required in each state
  - State-specific APR caps: range from 0% (some states ban interest) to 36%
  - State-specific late fee caps: $0 to $25 or % of payment
  - CFPB federal oversight (BNPL treated as credit cards since 2024)

European Union:          27 member states
  - Consumer Credit Directive (CCD) 2023/2225: creditworthiness assessment mandatory
  - SECCI document required before commitment
  - 14-day right of withdrawal
  - Per-country APR caps and consumer protection variations

United Kingdom:          FCA-regulated since 2025
  - FCA authorization required for BNPL providers
  - Affordability assessment mandatory
  - Consumer Duty obligations
  - Financial Ombudsman jurisdiction for complaints
...
Total regulatory configurations:  100+ jurisdiction-specific rule sets
Regulatory change frequency:      ~15-20 material changes per year globally
Compliance staff:                 50+ (legal + compliance + regulatory affairs)
```
...
6. **Unit economics are razor-thin per plan**: At ~$2.95 net margin per $150 plan, the business model depends on volume and tight loss control. A 1% swing in default rate ($70M impact) can exceed the entire infrastructure budget. This makes ML model accuracy and collections efficiency existential concerns, not optimization opportunities.

7. **Regulatory jurisdiction count drives configuration complexity**: With 100+ jurisdiction-specific rule sets (APR caps, fee limits, disclosure formats, grace periods), the compliance engine is one of the most complex services in the system---managing more distinct configurations than the payment orchestration layer.
