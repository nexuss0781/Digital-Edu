...
| **Data Residency Controls** | Keep specific data in designated regions only (GDPR, LGPD, DPDP Act) |
| **Conflict Callbacks** | Application-defined conflict resolution hooks |
| **Time-Travel Queries** | Read data as of a specific timestamp |
| **Cell-Based Isolation** | Subdivide regions into independent cells for blast radius containment |
| **Edge Read Replicas** | Serve reads from edge locations with configurable staleness bounds |
