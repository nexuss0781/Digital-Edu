...
| **Managed NoSQL Streams** | Cloud-managed | Serverless, CDC triggers | Cloud-native apps |
...
| Design | Relationship |
|--------|--------------|
| [1.19 CQRS Implementation](../1.19-cqrs-implementation/00-index.md) | Natural companion pattern -- separate read/write models for event-sourced aggregates |
| [1.17 Distributed Transaction Coordinator](../1.17-distributed-transaction-coordinator/00-index.md) | Saga orchestration with event-sourced state machines |
| [1.6 Distributed Message Queue](../1.6-distributed-message-queue/00-index.md) | Event distribution to external consumers and cross-service integration |
| [1.5 Distributed Log-Based Broker](../1.5-distributed-log-based-broker/00-index.md) | Similar append-only architecture; often used as the event store backbone |
| [16.8 Change Data Capture System](../16.8-change-data-capture-system/00-index.md) | CDC provides an alternative event stream from existing databases; shares gap detection and ordering challenges |
| [1.7 Distributed Unique ID Generator](../1.7-distributed-unique-id-generator/00-index.md) | Global position sequencing shares the same monotonic ID generation Slowest part of the process |
| [1.3 Distributed Key-Value Store](../1.3-distributed-key-value-store/00-index.md) | Snapshot storage backend; read-your-writes consistency model |
| [8.3 Zerodha](../8.3-zerodha/00-index.md) | Financial trading platform where event sourcing provides mandatory audit trails and regulatory compliance |
...
- Cloud Architecture Documentation: Event Sourcing Pattern
