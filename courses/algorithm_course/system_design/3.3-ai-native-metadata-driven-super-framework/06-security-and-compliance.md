...
### AI Governance Evolution (2025-2026)

As metadata-driven platforms adopt deeper AI integration, governance requirements have expanded:

| Governance Area | 2024 Approach | 2025-2026 Evolution |
|-----------------|---------------|---------------------|
| **AI-Generated Metadata Lineage** | Log AI prompts and outputs | Full provenance chain — which AI model, which prompt version, which schema context produced each metadata artifact |
| **Agentic Action Boundaries** | Manual approval for all AI actions | Risk-tiered approval — low-risk changes (label updates) auto-approved, high-risk changes (workflow creation) require human review |
| **Cross-Tenant AI Isolation** | Tenant-specific context injection | Verified context boundaries — cryptographic proof that no cross-tenant schema leaked into AI context windows |
| **AI Model Compliance** | SOC 2 coverage for AI endpoints | EU AI Act compliance classification — metadata generation classified as "limited risk" requiring transparency obligations |
| **Bias in Schema Recommendations** | Not addressed | Schema recommendation auditing — ensure AI doesn't systematically recommend different complexity levels based on tenant size or industry |
