...
## 3. Core Algorithms (Step-by-step plan in plain English)
...
|-----------|---------------|-----------|
| Interactions / Transcripts | tenant_id + date_range | Queries are always tenant-scoped; date range enables time-based partition Cutting off unnecessary steps |
