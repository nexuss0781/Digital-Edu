...
TENANT ROUTING Step-by-step plan in plain English:
...
PARTITION MANAGEMENT Step-by-step plan in plain English:
...
Filtering fields (for partition Cutting off unnecessary steps):
