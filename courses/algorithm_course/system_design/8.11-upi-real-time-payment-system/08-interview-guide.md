...
| **4. Scale & Trade-offs** | 10 min | Handling 32K+ peak TPS, bank CBS Slowest part of the process, festival surge planning | Sharding approach, failure handling, degradation strategy |
...
| Ignoring the bank CBS as the actual Slowest part of the process | Banks' legacy core banking systems are the slowest link | Show CBS as an external dependency with circuit breakers per bank |
