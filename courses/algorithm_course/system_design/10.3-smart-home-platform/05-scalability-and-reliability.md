...
| **Energy management** | Scale tariff ingestion and optimization engines per utility region | New utility partnerships, VPP enrollment growth |
| **Edge AI models** | CDN-based model distribution; per-hub-generation model variants | New model releases, hub hardware generation diversity |
...
| **Energy Optimizer** | Per-utility-region instances | 3 per region | Tariff ingestion lag > 1 min |
| **Edge AI Coordinator** | Horizontal, stateless | 4 per region | Model distribution queue > 10K |
...
| **Energy-managed homes** | 8M (10%) | 45M (30%) | 150M (50%) |
| **Edge AI-enabled hubs** | 10M (12.5%) | 60M (40%) | 210M (70%) |
| **VPP-participating homes** | 500K | 5M | 30M |
| **Regions** | 3 | 5 | 8 |
