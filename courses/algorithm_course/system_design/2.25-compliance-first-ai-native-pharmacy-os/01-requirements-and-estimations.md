...
|-------------|-------------|---------------------|
| **Inventory Tracking** | Track drug inventory with batch, lot, and expiry at SKU level | FIFO (First-In-First-Out, like a line at a store)/FEFO enforcement, real-time stock visibility |
...
| **DSCSA** | Drug serialization, package verification | GS1 DataMatrix scanning, EPCIS event store, 6-year retention |
| **NCPDP F6** | Claims telecommunication standard (replaces D.0) | Protocol adapter, ePA support, Jan 2028 deadline |
...
| **NABP Pulse (DSCSA)** | REST / GS1 EPCIS | < 5s | 99% |
