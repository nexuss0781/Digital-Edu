...
### Daily Pattern (Business SaaS)

```
Request Volume (Global)
    │
  4x├─────────────────────────────────────────╮
    │         India + EU overlap              │  US + India overlap
  3x├─────────╮                               │  ╭──────╮
    │         │                               ╰──╯      │
  2x├─╮       │   ╭───╮                                 │
    │ │  EU   │   │   │    US business hours             │
  1x├─╯ start ╰───╯   ╰───────────────────╮             │
    │                                      ╰─────────────╯
    └──────────────────────────────────────────────────────
...
|---|---|---|
| **End of financial quarter** | 2-3x Books/Invoice traffic | Last 5 days of quarter |
| **Tax filing season** | 3-4x Books traffic in India (March), US (April) | 2-3 weeks |
| **New year provisioning** | Burst of new org creation and user provisioning | First 2 weeks of January |
| **Product launches** | Spike in sign-ups and trial activations | 1-2 days post-announcement |
| **End of month payroll** | 2x People/Payroll traffic | Last 3 days of month |

### Geographic Distribution

| Region | % of Traffic | Peak Hours (UTC) | Primary Products |
|---|---|---|---|
| India | 35% | 03:00 - 11:00 | CRM, Books, People, Desk |
| Americas | 25% | 13:00 - 21:00 | CRM, Mail, Projects |
| Europe | 20% | 07:00 - 15:00 | CRM, GDPR-compliant products |
| APAC (ex-India) | 12% | 00:00 - 08:00 | CRM, ManageEngine |
| Middle East & Africa | 8% | 05:00 - 13:00 | Books, CRM |
...
|---|---|---|
| Private data center infrastructure | $150M - $250M | Custom hardware, power, cooling across 18 DCs |
| GPU clusters (Zia LLM) | $30M - $60M | 128 H100 equivalents for training + inference fleet |
| Network bandwidth | $20M - $40M | Inter-DC replication, customer egress |
| Staffing (engineering) | $300M - $500M | 12,000+ engineers across 55+ products |
| **Revenue model** | Zoho One: $45/user/month | All 50+ apps under single per-employee license |
| **Unit economics** | ~$8-12/user/year infrastructure | Private infra advantage vs ~$30-50/user on public cloud |

> **Key Insight:** Zoho's private infrastructure advantage translates to roughly 3-4x lower per-user infrastructure cost compared to competitors running on public cloud, enabling aggressive pricing ($45/user/month for 50+ apps vs $300+/user for comparable Salesforce + Microsoft stacks).
