...
| **Replication lag > 30 seconds** | Cross-DC or primary-replica lag sustained | Monitor trend, investigate network or I/O Slowest part of the process |
...
| **Event bus consumer lag growing** | Consumer lag increasing for > 15 minutes | Scale consumer instances, investigate processing Slowest part of the process |
