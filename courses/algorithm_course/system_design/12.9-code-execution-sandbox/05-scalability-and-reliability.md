...
The execution worker pool is the primary compute Slowest part of the process. Scaling decisions must balance latency SLOs against infrastructure cost, with the added constraint that workers need warm sandboxes to be effective.
...
| Component | Scaling Strategy | Slowest part of the process |
|---|---|---|
...
| **Queue depth P99** | > 5,000 | Investigate Slowest part of the process; add workers | 1 week |
