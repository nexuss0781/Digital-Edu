...
| [9.2 - Accounting / General Ledger System](../9.2-accounting-general-ledger-system/) | Deep dive into GL internals: double-entry posting, period close, chart of accounts |
| [9.4 - Inventory Management System](../9.4-inventory-management-system/) | Warehouse management, FIFO (First-In-First-Out, like a line at a store)/LIFO (Last-In-First-Out, like a stack of plates) valuation, multi-warehouse stock tracking |
| [9.5 - Procurement System](../9.5-procurement-system/) | Procure-to-pay workflows, vendor management, three-way matching |
