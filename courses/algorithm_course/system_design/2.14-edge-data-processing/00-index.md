...
| [04 - Deep Dive & Bottlenecks](./04-deep-dive-and-bottlenecks.md) | Critical components, failure modes, Slowest part of the process analysis |
...
- [2.15 - Edge-Native Feature Flags](../2.15-edge-native-feature-flags/00-index.md) - Configuration at edge
- [2.22 - AI-Native Offline-First POS](../2.22-ai-native-offline-first-pos/00-index.md) - CRDTs, offline-first sync, terminal coordination
- [2.2 - Container Orchestration System](../2.2-container-orchestration-system/00-index.md) - K3s/KubeEdge for edge orchestration
- [2.9 - Multi-Region Active-Active](../2.9-multi-region-active-active/00-index.md) - Eventual consistency, conflict resolution patterns
- [10.5 - Industrial IoT Platform](../10.5-industrial-iot-platform/00-index.md) - TSN, OPC-UA, factory floor edge processing
- [1.18 - Event Sourcing System](../1.18-event-sourcing-system/00-index.md) - Append-only event logs, replay capability
- [3.11 - AIOps System](../3.11-aiops-system/00-index.md) - Anomaly detection on streaming data
