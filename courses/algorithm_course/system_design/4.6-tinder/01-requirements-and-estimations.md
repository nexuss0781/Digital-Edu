...
| **Face Check** | Mandatory video selfie liveness + deepfake detection (2025+) | P1 |
| **Top Picks** | Curated daily recommendations | P1 |
| **Activity Status** | Show recently active users | P1 |

### AI-Driven Features (2025-2026)

| Feature | Description | Priority |
|---------|-------------|----------|
| **Chemistry** | Multimodal AI matching combining questionnaire, camera roll analysis, and behavioral signals | P1 |
| **AI Profile Feedback** | NLP-powered suggestions for improving bio text and photo selection | P2 |
| **Conversation Starters** | AI-generated opening messages tailored to match's profile | P2 |
| **Intent Classification** | Algorithm classifies user intent (casual, serious, exploratory) and adjusts recommendations | P2 |
| **Scam Detection** | Real-time NLP detection of romance scam and "pig butchering" patterns in messages | P1 |
...
- Stories feature
- IRL events (separate product, launched 2026)
