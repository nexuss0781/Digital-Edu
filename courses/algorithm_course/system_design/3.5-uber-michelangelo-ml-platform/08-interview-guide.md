...
## Emerging Topics (2025-2026 Bonus Credit)

| Topic | Key Points |
|-------|------------|
| **Vector Store Platform** | Billion-scale embedding management; HNSW indexing; 1.5B+ items at P99 120ms; embeddings as first-class ML citizens |
| **Model Excellence Scores** | SRE-inspired quality framework; 5 dimensions (data quality, freshness, drift, interpretability, accuracy); 60% prediction improvement |
| **Deployment Safety** | Shadow testing on 75%+ critical models; endpoint vs deployment shadow modes; automatic rollback on threshold breaches |
| **Palette Meta Store Re-architecture** | Server-side proto-backed schema validation; incremental delta computation; metadata updates from hours to minutes |
| **LLM Training Optimization** | DeepSpeed ZeRO-3 (34% GPU memory reduction) + Flash Attention (50% memory reduction); A100 vs H100 evaluation |
| **GenAI Gateway** | Multi-provider LLM routing (OpenAI, internal); PII redaction; 16M queries/month; cost guardrails and attribution |
| **Feature-Vector Convergence** | Unification of traditional feature stores with vector/embedding stores for GenAI workloads |
...
- [Palette Meta Store Journey](https://www.uber.com/blog/palette-meta-store-journey/)
- [Model Deployment Safety](https://www.uber.com/blog/raising-the-bar-on-ml-model-deployment-safety/)
- [Model Excellence Scores](https://www.uber.com/blog/enhancing-the-quality-of-machine-learning-systems-at-scale/)
- [Billion-Scale Vector Search](https://www.uber.com/blog/powering-billion-scale-vector-search-with-opensearch/)
- [LLM Training Optimization](https://www.uber.com/blog/open-source-and-in-house-how-uber-optimizes-llm-training/)
- [GenAI Gateway](https://www.uber.com/blog/genai-gateway/)
