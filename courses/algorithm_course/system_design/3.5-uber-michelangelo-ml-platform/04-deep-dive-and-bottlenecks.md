...
### Slowest part of the process 1: Feature Store Cassandra Latency
...
### Slowest part of the process 2: Model Loading Latency
...
2. ARTIFACT OPTIMIZATION
   ...
   - Model Cutting off unnecessary steps for smaller size
...
### Slowest part of the process 3: Training Job Scheduling
