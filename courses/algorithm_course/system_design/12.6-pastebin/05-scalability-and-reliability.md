...
└── Slowest part of the process: Primary write throughput at ~5K writes/sec
...
└── Slowest part of the process: Single primary I/O at ~10K writes/sec
...
└── Slowest part of the process: Effectively eliminated for single-paste operations
...
└── Rarely a practical Slowest part of the process
```
