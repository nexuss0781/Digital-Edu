...
|-----------|--------------------------|
| [3.25 AI Observability Platform](../3.25-ai-observability-platform/00-index.md) | Centralized model performance monitoring for ranking and retrieval models, embedding drift detection, and recommendation quality dashboards across serving infrastructure |
| [3.26 AI Governance & Compliance](../3.26-ai-governance-compliance/00-index.md) | Bias and fairness auditing for recommendation outputs, diversity compliance reporting, and A/B test governance for model rollout decisions |

**Key integration points:**
- Ranking model AUC/NDCG metrics and concept drift signals feed into the centralized AI Observability dashboards
- Diversity, fairness, and filter bubble metrics are exported for governance compliance reporting
- A/B test results and model promotion decisions are tracked in the governance audit trail
