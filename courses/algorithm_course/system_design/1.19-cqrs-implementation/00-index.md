...
| [09 - Key Insights](./09-insights.md) | 12 architectural insights, cross-references |
...
| **NoSQL + Relational** | Managed Cloud | Key-value store for reads, relational for writes | Serverless |
| **Global DB + CDC** | Managed Cloud | Change feed for projections | Global distribution |
...
| Design | Relationship |
|--------|--------------|
| [1.18 Event Sourcing System](../1.18-event-sourcing-system/00-index.md) | Often paired with CQRS, events as single source of truth |
| [1.17 Distributed Transaction Coordinator](../1.17-distributed-transaction-coordinator/00-index.md) | Saga pattern with CQRS for cross-aggregate transactions |
| [1.6 Distributed Message Queue](../1.6-distributed-message-queue/00-index.md) | Event distribution between command and query sides |
| [1.3 Distributed Key-Value Store](../1.3-distributed-key-value-store/00-index.md) | Read model storage for high-throughput lookups |
| [1.5 Distributed Cache](../1.5-distributed-cache/00-index.md) | Caching layer for read models and projection results |
| [16.8 Change Data Capture](../16.8-change-data-capture/00-index.md) | CDC as outbox relay mechanism |
| [1.7 Unique ID Generator](../1.7-unique-id-generator/00-index.md) | Event ID and aggregate ID generation |
| [8.3 Zerodha Trading Platform](../8.3-zerodha-trading-platform/00-index.md) | CQRS in high-throughput financial systems |
...
- Cloud Architecture Documentation: CQRS Pattern
