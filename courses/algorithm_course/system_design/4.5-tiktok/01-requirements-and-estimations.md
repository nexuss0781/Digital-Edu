...
|-------------|--------|-----------|
| **Horizontal Scaling** | Linear up to 10x current load | Handle growth without re-architecture |
| **Multi-Region** | Active-active in 3+ regions | Regulatory (Project Texas, Project Clover) and latency |
| **ML Model Update** | <5 min global propagation | Online training freshness requirement |
| **CDN Expansion** | Add PoPs without downtime | Growing user base in new markets |
| **Storage Elasticity** | Auto-scale with 62 PB/year growth | Video storage growth rate |
