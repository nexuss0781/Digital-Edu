...
| **Vector Databases** | ANN search for candidate retrieval |
| **E-commerce Systems** | TikTok Shop transaction processing |

---

## Advanced Discussion Topics (Senior/Staff Level)

### Topic 1: Algorithm Accountability

**Question:** "How would you design TikTok's recommendation system to comply with the EU Digital Services Act requirement for algorithm transparency and user opt-out?"

**Key Points:**
- Logging all recommendation decisions with explanations
- Providing a non-personalized chronological feed option
- Enabling researcher access to anonymized recommendation data
- Balancing transparency with protecting proprietary algorithms
- The cost of maintaining parallel personalized/non-personalized feed paths

### Topic 2: Multi-Region ML Training

**Question:** "TikTok must train separate recommendation models for US and EU users (data can't cross borders). How does this affect model quality?"

**Key Points:**
- Smaller regional datasets reduce training signal diversity
- Transfer learning: pre-train on anonymized global patterns, fine-tune regionally
- Federated learning approaches for sharing model architecture without data
- Cost: 3x the training infrastructure (US, EU, APAC)
- Quality measurement: A/B test regional vs hypothetical global model

### Topic 3: Content-Commerce Cannibalisation

**Question:** "TikTok Shop content competes with entertainment content in the FYP. How do you balance commerce and entertainment without degrading user experience?"

**Key Points:**
- Multi-objective optimization: engagement + revenue
- Commerce content cap per session (e.g., max 15-20% of FYP)
- Users who engage with shopping get more; users who skip get less
- Separate commerce quality score to prevent low-quality product spam
- Measuring session-level satisfaction, not just per-video engagement
