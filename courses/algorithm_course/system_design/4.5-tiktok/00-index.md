...
| Design | Relevance |
|--------|-----------|
| [Instagram](../4.3-instagram/00-index.md) | Media processing, Stories, Reels competition -- shared video pipeline patterns |
| [Recommendation Engine](../3.12-recommendation-engine/00-index.md) | ML ranking fundamentals, Two-Tower retrieval, DLRM architecture |
| [LLM Inference Engine](../3.23-llm-inference-engine/00-index.md) | Low-latency ML serving, model quantization, GPU batching |
| [CDN Design](../1.15-content-delivery-network-cdn/00-index.md) | Edge caching, multi-CDN strategy, cache invalidation |
| [Blob Storage System](../1.12-blob-storage-system/00-index.md) | Video storage patterns, multi-region replication |
| [Feature Store](../3.16-feature-store/00-index.md) | ML feature serving, sub-ms embedding lookups |
| [Vector Database](../3.14-vector-database/00-index.md) | ANN search (HNSW/IVF) for candidate retrieval |
| [Real-Time Analytics](../2.14-real-time-analytics-platform/00-index.md) | Streaming analytics for engagement signals |
