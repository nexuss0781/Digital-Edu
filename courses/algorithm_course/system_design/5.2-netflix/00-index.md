...
| System | Relevance |
|--------|-----------|
| [YouTube](../5.1-youtube/00-index.md) | Video streaming comparison, different content model (UGC vs curated) |
| [Netflix CDN](../5.3-netflix-cdn/00-index.md) | Detailed Open Connect architecture, two-tier ISP-embedded delivery |
| [CDN Design](../1.15-content-delivery-network-cdn/00-index.md) | Edge caching patterns, origin-fill strategies |
| [Recommendation Engine](../3.12-recommendation-engine/00-index.md) | ML-based personalization, two-stage ranking pipeline |
| [Blob Storage](../1.12-blob-storage-system/00-index.md) | Object storage patterns for video content |
| [Distributed Cache](../1.4-distributed-lru-cache/00-index.md) | EVCache architecture, feature store caching |
| [Distributed Log-Based Broker](../1.5-distributed-log-based-broker/00-index.md) | Kafka Keystone Pipeline, 2T messages/day event streaming |
| [API Gateway Design](../1.14-api-gateway-design/00-index.md) | Zuul gateway patterns, rate limiting, request routing |
