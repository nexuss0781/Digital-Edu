...
| **Domain Modeling** | Upper Metamodel (UDA) | "Model once, represent everywhere" |

**Unified Data Architecture (UDA):**

Netflix's Upper metamodel addresses schema divergence across 200+ microservices. Built on W3C standards (RDF, SHACL), Upper defines domain entities once and automatically projects them into GraphQL schemas, Avro records, Iceberg tables, and SQL definitions. This eliminates costly point-to-point translation layers between teams and ensures that a "title" entity has consistent representation across the catalog service, analytics pipeline, and recommendation system.
