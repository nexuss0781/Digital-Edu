...
- Anomaly detection flagging on transaction patterns
- Document extraction from KYC submissions
- Auto-routing of support queries by intent classification

### What AI Can Recommend But Not Execute
- Fraud alert escalation priorities
- Credit limit adjustment recommendations
- Product cross-sell and upsell suggestions
- Risk rating changes for customer accounts
- Suspicious activity report (SAR) draft generation

### What Requires Human Approval
- Account opening and closure decisions
- Loan approval and disbursement
- Fraud case resolution and account freezing
- Regulatory reporting submissions (SAR, CTR)
- Interest rate or fee structure changes
- Large-value transaction overrides

### Deterministic Source of Truth
The core banking ledger is the system of record. AI writes to a recommendation layer only — account mutations, fund transfers, and regulatory filings require human or deterministic-system action through the transactional core with ACID guarantees.

### Rollback Path
Banking officers can override any AI-generated recommendation or alert. All overrides are logged with rationale. Transaction reversals follow standard banking reconciliation procedures. AI recommendations and human decisions are tracked separately for regulatory audit and model governance.
