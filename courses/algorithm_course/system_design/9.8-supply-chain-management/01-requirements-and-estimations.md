...
|---------------|-----------------|-------------------|-------------|
| **Order records** | 7 years | Financial audit requirements (SOX, local tax law) | Hot 90 days → warm 2 years → cold archive |
| **Inventory transactions** | 7 years | Financial audit; FDA FSMA for food supply chains | Hot 30 days → warm 1 year → cold archive |
| **Shipment tracking events** | 5 years | Carrier dispute resolution; customs audit | Hot 30 days → warm 1 year → cold Parquet |
| **IoT sensor raw data** | 90 days (raw); 2 years (aggregated) | Cold chain compliance (FDA/GDP); cost-driven | Hot 24 hours → warm 90 days → cold aggregates |
| **Demand forecasts** | Indefinite | ML model accuracy analysis; no regulatory mandate | Warm (all cycles); small per-record footprint |
| **EDI messages** | 7 years | B2B contractual; customs audit | Warm 1 year → cold archive |
| **Audit logs** | 7 years | SOX, GDPR, DSCSA | Append-only with hash chain; never deleted |
| **Supplier/carrier PII** | Duration of relationship + 3 years | GDPR right to erasure; data retention policies | Encrypted at rest; anonymized after retention period |
| **Carbon emissions data** | 10 years | EU CSRD, SEC climate disclosure, CBAM | Warm indefinitely; used for trend reporting |
