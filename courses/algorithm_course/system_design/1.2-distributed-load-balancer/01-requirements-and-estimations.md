...
| Full WAF/IDS/IPS | Separate security appliance |
| Global server load balancing | Separate GeoDNS/GSLB system |
| Content caching | Delegated to CDN or dedicated cache layer |
