...
| Feature | Description | Priority |
|---------|-------------|----------|
| **Multi-Modal Translation** | Image OCR, video subtitle extraction, document layout preservation | P2 |
| **Real-Time Translation** | WebSocket-based streaming translation for chat/support | P2 |
| **Custom Model Training** | Domain-specific NMT fine-tuning with LoRA adapters | P2 |
| **Translation Review Workflows** | Multi-stage review with approval chains and reviewer certification | P2 |
| **Cost Optimization** | Token/word cost tracking, budget alerts, engine cost comparison | P2 |
| **RAG-Augmented Translation** | Retrieve domain corpora and style guides as LLM context | P2 |
| **Hallucination Detection** | Source-target alignment verification for LLM translations | P2 |
| **Hybrid NMT+LLM Pipeline** | NMT draft → LLM refinement cascade for quality-cost balance | P2 |
...
- **End-to-end speech translation** (use dedicated models like SeamlessM4T)
...
| Component | Current | Maximum Practical | Slowest part of the process |
|-----------|---------|-------------------|------------|
