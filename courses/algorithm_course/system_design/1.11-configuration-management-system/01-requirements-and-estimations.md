...
| **Write Throughput** | > 10,000 ops/sec | Single leader Slowest part of the process limits this |
...
| **Watch Ordering** | FIFO (First-In-First-Out, like a line at a store) per connection | Events delivered in order they occurred |
...
| Sequential Revisions | Global revision number for ordering | Single counter is potential Slowest part of the process |
