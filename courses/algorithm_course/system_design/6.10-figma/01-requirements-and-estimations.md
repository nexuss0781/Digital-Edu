...
Year 1 (MVP):
  Users: 500K DAU
  Files: 5M total
  Architecture: Single-region, monolithic multiplayer server
  Team: 10 engineers
  Focus: Core editing, basic multiplayer, WebGL rendering

Year 2 (Product-Market Fit):
  Users: 2M DAU
  Files: 20M total
  Architecture: Horizontal multiplayer, component library system
  Key additions: Auto-layout, prototyping, plugins, team libraries
  Team: 40 engineers

Year 3 (Enterprise Scale):
  Users: 4M+ DAU, 15M MAU
  Files: 50M+ total
  Architecture: Multi-region, edge CDN, lazy page loading
  Key additions: Dev mode, design tokens/variables, branching,
                 AI features, FigJam (whiteboarding)
  Team: 100+ engineers

Year 4+ (Platform):
  Users: 10M+ DAU projected
  Files: 200M+ total
  Architecture: WebGPU migration, local-first capabilities,
                advanced AI co-pilot, code generation
  Key additions: WebGPU rendering, enhanced offline,
...
```
Phase 1 (Core):
  ✓ Vector canvas editing at 60 FPS
  ✓ Real-time multiplayer (2-10 users)
  ✓ Basic components and styles
  ✓ WebSocket-based collaboration

Phase 2 (Collaboration):
  ✓ 500-user concurrent editing
  ✓ Component library publishing
  ✓ Version history with restore
  ✓ Plugin ecosystem with sandbox

Phase 3 (Enterprise):
  ✓ Design tokens / variables with modes
  ✓ Branching and merging
  ✓ Dev mode with code generation
  ✓ SSO / SCIM / audit logging

Phase 4 (AI-Augmented):
  ✓ AI layout suggestions
  ✓ Auto-populate with realistic data
  ✓ Image generation within canvas
