...
```
Step-by-step plan in plain English: Session Architecture
...
```
Step-by-step plan in plain English: Link Sharing Permission Check
...
```
Step-by-step plan in plain English: Operation Authorization
...
```
Step-by-step plan in plain English: IP-Based Access Control
