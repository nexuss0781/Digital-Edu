...
|--------|-----------|----------------|-----------------|---------------------|
| USA | HIPAA/HITECH + HTI-1 | No mandate | 6 years | 60 days |
...
### HIPAA Security Rule 2025 Impact

The January 2025 NPRM eliminates the "addressable" vs "required" distinction, making all implementation specifications mandatory:

| New Requirement | Previous Status | System Impact |
|----------------|-----------------|---------------|
| **MFA for all ePHI access** | Addressable | Universal MFA enforcement |
| **Encryption at rest and in transit** | Addressable | AES-256 mandatory, no exceptions |
| **Network segmentation** | Best practice | Documented network maps required |
| **72-hour system restoration** | Not specified | DR architecture must meet this |
| **15-day critical patching** | Not specified | Automated patch management pipeline |
| **Annual risk assessment** | Periodic | Formalized annual methodology |
| **Technology asset inventory** | Not specified | Annual ePHI asset tracking |
| **6-month vulnerability scanning** | Not specified | Automated scanning pipeline |
| **Annual penetration testing** | Not specified | Third-party pentest requirement |
| **BA security verification** | Not specified | Annual business associate audits |
