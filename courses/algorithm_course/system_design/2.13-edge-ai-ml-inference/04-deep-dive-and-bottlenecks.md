...
### Slowest part of the process 1: Model Load Time
...
### Slowest part of the process 2: NPU Availability
...
### Slowest part of the process 3: FL Communication
...
### Slowest part of the process 4: Memory During Inference

| Cause | Impact | Detection | Mitigation |
|-------|--------|-----------|------------|
| Model too large | OOM crash | Memory monitoring | Quantization, Cutting off unnecessary steps |
