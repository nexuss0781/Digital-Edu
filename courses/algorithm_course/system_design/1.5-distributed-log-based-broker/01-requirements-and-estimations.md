...
| Feature | Reason |
|---------|--------|
| Message priorities | Log-based systems are FIFO (First-In-First-Out, like a line at a store) by design |
...
│                                                                  │
│  6. WITH TIERED STORAGE (Kafka 4.0+)                            │
│  ─────────────────────────────────────                          │
│  Local retention: 1 day                                         │
│  Local storage: 300 GB × 1 × 1.6 = 480 GB (broker disk)        │
│  Remote retention: 6 days                                       │
│  Remote storage: 100 GB × 6 = 600 GB (object storage, no RF)   │
│                                                                  │
│  Comparison (7-day retention):                                  │
│  • Without tiered: 3.4 TB broker disk (NVMe)                   │
│  • With tiered: 480 GB NVMe + 600 GB object storage             │
│  • Cost savings: ~3-5× (object storage ~10× cheaper per GB)    │
│                                                                  │
│  For 90-day retention:                                          │
│  • Without tiered: 300 GB × 90 × 1.6 = 43.2 TB (NVMe!)        │
│  • With tiered: 480 GB NVMe + 8.4 TB object storage            │
│  • Cost savings: ~8-9×                                          │
│                                                                  │
└─────────────────────────────────────────────────────────────────┘
```
...
| Broker disk usage | > 70% | > 85% | Add storage, enable tiered storage, or reduce local retention |
