...
| FR-23 | **Earned Wage Access (EWA)** | On-demand pay advances with real-time net pay estimation and state-specific EWA compliance |
| FR-24 | **Continuous Payroll** | Event-driven payroll processing that calculates in real-time rather than batch-only |
| FR-25 | **Multi-Entity Consolidation** | Consolidated payroll reporting across legal entities, currencies, and jurisdictions |
| FR-26 | **AI-Assisted Payroll Journal Entries** | Automatic GL account mapping and journal entry generation with variance detection |
...
### 5.5 Earned Wage Access (EWA) Regulations (2025+)

| Regulation | Scope | Key Requirements | Implementation |
|------------|-------|------------------|----------------|
| **State EWA Laws** | CA, NV, MO, NE, CT, others | EWA providers must register, disclose fees, honor repayment schedules | Real-time net pay estimation engine, fee transparency module |
| **CFPB Guidance** | US Federal | EWA classified as payroll advance or consumer loan depending on structure | Compliance classification engine, terms-of-service generation |
| **Wage Assignment Rules** | Varies by state | Limits on percentage of wages assignable for advance | Disposable income calculation, state-specific caps |
