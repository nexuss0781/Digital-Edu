...
### Daily Pattern (Multi-Timezone SME Platform)

```
Order Volume (Platform-Wide)
    │
  3x├─────────────────────────────────────────╮
    │         APAC evening               │  Americas evening
  2x├─╮       shopping peak              │  ╭──────╮
    │ │  India                           ╰──╯      │
  1x├─╯ evening ╰───╮   EU evening                 │
    │               ╰────────────────╮              │
    │                                ╰──────────────╯
    └──────────────────────────────────────────────────
    0   4   8   12  16  20  24  (hour UTC)
        APAC     EU      Americas    Night
        Peak     Peak    Peak        Low
```

### Seasonal Spikes

| Event | Impact | Duration | Regions |
|---|---|---|---|
| **Diwali / Festival season** | 3-5x order volume; 2x sync events | 2-3 weeks (October-November) | India, Southeast Asia |
| **Black Friday / Cyber Monday** | 3x order volume; heavy flash sales | 4-5 days | Americas, Europe |
| **Year-end stock clearance** | 2x markdown operations; high reconciliation | Last 2 weeks of December | Global |
| **Chinese New Year** | 3x for food/gift categories; supplier lead time doubles | 3-4 weeks | APAC |
| **Back to school** | 2x for stationery/electronics SMEs | 3 weeks (August-September) | Americas, Europe |
| **Ramadan / Eid** | 2-3x for food/fashion categories | 1 month + 1 week | Middle East, Southeast Asia |

### Cost Model

| Component | Monthly Cost | Notes |
|---|---|---|
| Forecast compute (CPU) | $15,000 | 450 cores × 6 hours/day × 30 days at on-demand pricing; spot instances reduce by 60% |
| GPU training cluster | $3,000 | 8 GPUs × 4 hours/week × 4 weeks |
| Hot tier storage | $5,000 | 5 TB at SSD-backed pricing |
| Warm tier storage | $8,000 | 78 TB at standard pricing |
| Cold tier archival | $500/year per TB | Compressed columnar format; minimal access |
| Network egress | $4,000 | 230 GB/day outbound |
| **Total infrastructure** | **~$36,000/month** | Across 100K tenants = **$0.36/tenant/month** |
| **Revenue at $50/tenant** | **$5,000,000/month** | Infrastructure = 0.7% of revenue — healthy margin |

> **Key insight:** At 100K tenants with $50 avg revenue, the platform achieves a 99.3% gross margin on infrastructure, validating the aggressive multi-tenancy architecture. The forecasting compute (the most expensive component) costs $0.15/tenant/month — less than a single oversold order's refund cost.
