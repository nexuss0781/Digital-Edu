...
Code-mixing in Indian voice commerce is not an Edge Case (Unusual or extreme situation)—it is the predominant speech pattern. Research on Indian speech patterns shows:
...
### Slowest part of the process 1: GPU Compute for Concurrent Real-Time ASR
...
flowchart TB
    ...
    subgraph Slowest part of the process["Slowest part of the process"]
        NEED["Need: 25,000/66\n= 379 GPUs\nfor ASR alone"]
        COST["GPU cost:\n$1.5/hr × 379\n= $568/hour\n= $13,636/day"]
    end
    ...
    classDef Slowest part of the process fill:#fff3e0,stroke:#e65100,stroke-width:2px
    classDef mitigation fill:#e1f5fe,stroke:#01579b,stroke-width:2px

    class CALLS,RATE load
    class A100,BATCH,UTIL gpu
    class NEED,COST Slowest part of the process
...
### Slowest part of the process 2: VAD Endpointing Latency
...
### Slowest part of the process 3: Vernacular Synonym Dictionary Cold Start
...
### Slowest part of the process 4: TTS Voice Quality Gap Across Languages
