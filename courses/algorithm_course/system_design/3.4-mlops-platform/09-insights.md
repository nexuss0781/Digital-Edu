...
**One-liner:** With 1000+ concurrent pipelines, a single scheduler instance becomes a state management Slowest part of the process, so pipelines are partitioned by hash and distributed across multiple scheduler instances, each managing a subset.
