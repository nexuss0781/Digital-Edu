...
| **EU AI Act high-risk audit** | Continuous + annual | Full AI pipeline |

---

## EU AI Act Compliance Timeline (2025-2026)

```
┌────────────────────────────────────────────────────────────────────┐
│ EU AI ACT: HIRING IS HIGH-RISK (ANNEX III, CATEGORY 4)             │
├────────────────────────────────────────────────────────────────────┤
│                                                                     │
│ ALREADY IN EFFECT (Feb 2, 2025):                                   │
│ ┌─────────────────────────────────────────────────────────────┐   │
│ │ • Emotion recognition in hiring BANNED (Article 5)           │   │
│ │ • Personality profiling from social behavior BANNED           │   │
│ │ • Biometric categorization by protected characteristics BANNED│   │
│ │ • Social scoring BANNED                                      │   │
│ └─────────────────────────────────────────────────────────────┘   │
│                                                                     │
│ MANDATORY BY AUG 2, 2026:                                          │
│ ┌─────────────────────────────────────────────────────────────┐   │
│ │ • Transparency: candidates must know AI is evaluating them   │   │
│ │ • Human oversight: SUBSTANTIVE, not ceremonial               │   │
│ │   - Personnel must understand AI outputs                     │   │
│ │   - Must be empowered to override recommendations           │   │
│ │   - Must be able to intervene in real-time                  │   │
│ │ • Data governance: documented data quality requirements     │   │
│ │ • Bias monitoring: continuous, not annual                   │   │
│ │ • Risk management: documented risk assessment systems       │   │
│ │ • Audit trails: every evaluation decision must be traceable │   │
│ │ • Right to explanation: candidates can contest decisions    │   │
│ │ • Right to human review: GDPR Art. 22 + AI Act Art. 86     │   │
│ └─────────────────────────────────────────────────────────────┘   │
│                                                                     │
│ PENALTIES (from 2027):                                             │
│   • Up to €35 million or 7% of global annual turnover             │
│   • U.S. employers covered if AI outputs used for EU candidates  │
│                                                                     │
│ CALIFORNIA FEHA (Oct 1, 2025):                                     │
│ ┌─────────────────────────────────────────────────────────────┐   │
│ │ • AI hiring tools subject to anti-discrimination law        │   │
│ │ • Meaningful human oversight with trained personnel          │   │
│ │ • Employers must proactively test for bias                  │   │
│ │ • 4-year record retention for AI decision data              │   │
│ └─────────────────────────────────────────────────────────────┘   │
│                                                                     │
│ COLORADO AI ACT (June 2026):                                       │
│   • High-risk AI requires "reasonable care" to prevent             │
