...
| **4. Scale & Trade-offs** | 12 min | Festival spike handling, NPCI as Slowest part of the process, multi-bank failover, budget contention | Scaling strategy, failure handling, degradation approach |
