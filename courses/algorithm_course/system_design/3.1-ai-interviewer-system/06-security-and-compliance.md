...
```
REQUIREMENTS:
  - Deployers of high-risk AI systems (including hiring tools) must:
    1. Use reasonable care to avoid algorithmic discrimination
    2. Implement a risk management policy and program
    3. Complete impact assessments before deployment and annually
    4. Notify consumers when AI makes consequential decisions
    5. Provide opt-out or appeal mechanism

  - Developers must:
    1. Disclose known risks of algorithmic discrimination
    2. Provide documentation on training data and limitations
    3. Make available results of evaluations for discrimination

IMPLEMENTATION:
  risk_management_program:
    - Annual impact assessment for each job category
    - Discrimination testing across protected classes
    - Documentation of training data provenance
    - Public statement describing AI use in hiring

  consumer_notification:
    - Pre-interview disclosure that AI is used
    - Explanation of what data is collected
    - Information on how to contest AI decisions
    - Opt-out mechanism (human interview alternative)
```

### Illinois AIVPA (Artificial Intelligence Video Interview Act)

**Active since 2020 — template for subsequent state laws**

| Requirement | Implementation |
|-------------|----------------|
| Written notice before AI analysis | Pre-interview disclosure email |
| Candidate consent to AI use | Explicit opt-in checkbox |
| Explanation of AI functionality | Public documentation page |
| Data deletion on request | Automated deletion within 30 days |
| Limited sharing | Video shared only with evaluators with expertise |
