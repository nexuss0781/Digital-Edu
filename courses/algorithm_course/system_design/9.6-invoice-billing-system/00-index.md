...
| [8.3 - Payment Gateway](../8.3-payment-gateway/) | Low-level payment processing; authorization and capture flows; settlement reconciliation |
| [1.1 - Distributed Rate Limiter](../1.1-distributed-rate-limiter/) | Rate limiting patterns for usage metering ingestion; API throttling; gateway request limits |
| [8.1 - Digital Wallet](../8.1-digital-wallet-system/) | Prepaid credit wallet patterns; stored value management; balance consistency |
| [9.4 - Audit Trail System](../9.4-audit-trail-system/) | Immutable audit logging for financial operations; tamper-evident records; compliance reporting |
