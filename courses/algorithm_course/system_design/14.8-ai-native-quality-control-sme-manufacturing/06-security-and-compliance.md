...
### AI-Specific Regulatory Compliance (Emerging 2025-2026)

```
EU AI Act (effective 2025-2026):
  - AI-based quality inspection in manufacturing is classified as
    "limited risk" or "high risk" depending on the industry
  - High-risk (automotive safety parts, medical devices, food):
    Requires: conformity assessment, risk management, technical
    documentation, transparency to downstream users, human oversight
  - Platform support:
    a. Technical documentation: auto-generated model cards with
       training data description, accuracy metrics, known limitations
    b. Human oversight: active learning review queue ensures human-in-the-loop
       for uncertain decisions; operator can override any model decision
    c. Risk management: shadow mode deployment validates safety before
       production use; automatic rollback protects against degradation
    d. Transparency: every inspection decision traceable to model version,
       confidence score, and input image — auditable by downstream customer
    e. Bias monitoring: track per-class performance across production batches
       to detect model drift or systematic bias

ISO/IEC 42001:2023 (AI Management System):
  - Framework for organizational AI governance
  - Platform provides: model lifecycle management, data governance controls,
    impact assessment templates, and audit trail infrastructure that support
    tenants in achieving ISO 42001 certification

NIST AI RMF (Risk Management Framework):
  - Voluntary framework adopted by many US manufacturers
  - Platform maps to NIST AI RMF functions:
    GOVERN: Role-based access, model governance policies
    MAP: Model lineage tracking, data provenance
    MEASURE: Continuous accuracy monitoring, drift detection
    MANAGE: Shadow mode, rollback, human override
```
