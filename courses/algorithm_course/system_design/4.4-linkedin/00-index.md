...
| RAG System | Retrieval-augmented generation for AI writing features | [3.15-rag-system](../3.15-rag-system/00-index.md) |
| AI Guardrails Safety System | Content moderation, AI output safety | [3.22-ai-guardrails-safety-system](../3.22-ai-guardrails-safety-system/00-index.md) |
...
|-------------|--------|--------|
| **LinkedIn Hiring Assistant** | Agentic AI that autonomously handles candidate sourcing, outreach drafting, and pipeline management for recruiters | GA (2025) |
| **AI-Powered Collaborative Articles** | LLM-generated seed questions invite expert contributions, now covering 9,000+ topics across professional domains | Expanding |
| **Video-First Content Strategy** | Short-form video in feed with in-app recording, reels-style format for professional content | Rolling out |
| **Premium Subscription Consolidation** | Unified Premium tiers (Career, Business, Sales, Recruiter Lite) with AI features as upsell differentiator | Active |
| **Economic Graph Expansion** | 41,000+ standardized skills taxonomy, company knowledge graph with layoff/hiring signals | Ongoing |
| **LLM Content Quality Scoring** | Batch-plus-fallback LLM classification for thought leadership vs generic advice detection in 360Brew | Production |
| **AI Profile Optimization** | Personalized suggestions for headline, summary, and skills based on job market demand signals | GA (2025) |
| **On-Platform Learning Paths** | LinkedIn Learning courses embedded in job recommendations, skill gap analysis for career transitions | Expanding |
