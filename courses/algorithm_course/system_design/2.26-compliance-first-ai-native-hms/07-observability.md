...
All AI components in this system (bed demand forecasting, EMPI matching, OR duration prediction, coding suggestions, anomaly detection) must integrate with the organization's AI observability and evaluation infrastructure.

| Capability | Reference Design | Integration Point |
|------------|-----------------|-------------------|
| **Drift Detection & Alerting** | [AI Observability & LLMOps Platform](../3.25-ai-observability-llmops-platform/00-index.md) | Input feature drift (PSI/KS), prediction distribution shift, data quality monitors |
| **Model Evaluation & Benchmarking** | [AI Model Evaluation & Benchmarking Platform](../3.26-ai-model-evaluation-benchmarking-platform/00-index.md) | Offline evaluation harness, A/B test analysis, bias/fairness audits across patient demographics |
| **Feedback Loop Tracking** | [AI Observability & LLMOps Platform](../3.25-ai-observability-llmops-platform/00-index.md) | Clinician override rates, coding acceptance rates, prediction-vs-actual tracking |

> **Cross-Reference Note:** The observability patterns in this document cover system-level metrics (latency, throughput, errors). For AI-specific observability — including drift detection dashboards, model performance degradation alerts, and evaluation pipelines — see the referenced designs above.
