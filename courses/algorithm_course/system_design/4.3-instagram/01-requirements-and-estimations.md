...
| MSVP Custom Silicon | 9-50x encoding speedup at ~10W | Custom ASIC replacing CPU-based encoding |
| Three-Stage Ranking Funnel | ~60% ML inference compute reduction | ESR stage filters candidates before heavy LSR |
...
| ExecuTorch On-Device ML | Reduced server-side inference load | 50KB runtime for client-side Super Resolution |

### Infrastructure Investment Context (2025-2026)

| Metric | 2025 | 2026 (Planned) |
|--------|------|----------------|
| Total Capex | $72B | $115-135B |
| Custom Silicon | MSVP (video), AI training chips | Next-gen MSVP, expanded chip portfolio |
| Data Centers | Hyperion (2,250 acres, 5GW capacity) | Multi-site expansion |
| Cooling | Liquid cooling rollout | Standard for all new builds |
| On-Device ML | ExecuTorch 1.0 GA (50KB footprint) | Expanded on-device model catalog |
