...
|--------|-------------|---------------|
| [Cloud File Storage](../6.1-cloud-file-storage/00-index.md) | Foundation | DMS builds on file storage but adds versioning, compliance, and workflow |
| [Real-Time Collaborative Editor](../6.8-real-time-collaborative-editor/00-index.md) | Co-authoring integration | Collaborative editing within documents; DMS manages the document lifecycle around it |
| [Enterprise Knowledge Management](../6.13-enterprise-knowledge-management-system/00-index.md) | Knowledge layer | DMS provides document storage; KM adds semantic search, taxonomy, and knowledge graphs |
| [Distributed Lock Manager](../1.8-distributed-lock-manager/00-index.md) | Core dependency | Check-in/check-out locking relies on distributed lock patterns with fencing tokens and TTL |
| [AI-Native Hybrid Search Engine](../3.29-ai-native-hybrid-search-engine/00-index.md) | Search evolution | Full-text search across binary formats; vector search for semantic document discovery |
| [AI-Native Document Processing](../3.31-ai-native-document-processing-platform/00-index.md) | Processing pipeline | OCR, text extraction, classification, and entity extraction from document content |
| [Secret Management System](../2.16-secret-management-system/00-index.md) | Security pattern | Encryption key management for document-at-rest encryption, key rotation |
| [Distributed Job Scheduler](../2.6-distributed-job-scheduler/00-index.md) | Async processing | Scheduling OCR, thumbnail generation, retention policy evaluation, and search indexing jobs |
...
|--------|-------|---------|
| Global ECM market size | ~$65B (2025) | Growing at ~14% CAGR driven by compliance and AI |
| SharePoint monthly active users | 200M+ | Across 400K+ organizations |
| Box managed content items | 150B+ | Across 100K+ business customers |
| AI-powered document features | 70%+ of vendors | Auto-classification, smart search, entity extraction |
| Average enterprise document count | 31M per 1,000 employees | Growing ~25% annually |
| Compliance-driven DMS adoption | 45% of purchases | Primary driver is regulatory compliance, not productivity |
