...
```
Step-by-step plan in plain English: Three-Way Merge
...
```
Step-by-step plan in plain English: Merge Base Discovery
...
```
Step-by-step plan in plain English: Squash Merge
...
```
Step-by-step plan in plain English: Rebase Merge
...
```
Step-by-step plan in plain English: Delta Compression for Pack Files
...
```
Step-by-step plan in plain English: Trigram Index for Code Search
