...
```
Step-by-step plan in plain English: Shallow Clone
...
```
Step-by-step plan in plain English: Partial Clone with Lazy Blob Fetch
...
```
Step-by-step plan in plain English: Sparse Checkout
...
```
Step-by-step plan in plain English: PR Mergeability Pipeline
...
```
Step-by-step plan in plain English: Job Execution on Ephemeral Runner
...
### Slowest part of the process: Job Queue Depth

During peak hours, the hosted runner pool may not have enough capacity for all queued jobs. Queue depth is the key Slowest part of the process metric.
...
```
Step-by-step plan in plain English: Incremental Index Update
...
```
Step-by-step plan in plain English: Branch Protection Check
...
```
Step-by-step plan in plain English: Webhook Delivery with Retry
