...
When discussing Snapchat, demonstrate breadth by connecting to related system design concepts:

| If Asked About... | Connect To... | Key Point |
|-------------------|---------------|-----------|
| Ephemeral storage | [Distributed Cache](../1.4-distributed-lru-cache/00-index.md) | Volatile memory as primary store, not cache -- deletion is physics, not logic |
| AR inference | [Edge AI/ML Inference](../2.13-edge-ai-ml-inference/00-index.md) | 16.67ms frame budget mirrors edge inference latency constraints |
| Location sharing | [Tinder](../4.6-tinder/00-index.md) | H3 hexagonal indexing used by both platforms |
| Stories TTL | [CDN Design](../1.15-content-delivery-network-cdn/00-index.md) | Multi-layer expiration is defense-in-depth for content TTL |
| Service mesh | [Service Mesh Design](../2.11-service-mesh-design/00-index.md) | Envoy at 10M+ QPS is the multicloud feasibility enabler |
| My AI safety | [AI Voice Assistant](../3.19-ai-voice-assistant/00-index.md) | Output safety classifiers apply to any consumer AI deployment |
| Content moderation | [Instagram](../4.3-instagram/00-index.md) | Server-side encryption enables moderation; contrast with WhatsApp's E2EE limitations |

---

## 2025-2026 Talking Points

When discussing recent developments, consider these topics:

| Topic | Key Point | Interview Value |
|-------|-----------|-----------------|
| **My AI** | GPT-powered chatbot with age-appropriate guardrails | Shows awareness of LLM safety in consumer products |
| **Spectacles AR** | 5th gen AR glasses extending on-device ML to wearables | Demonstrates understanding of form-factor constraints |
| **Snapchat+** | 12M+ subscribers; premium feature gating | Illustrates tiered architecture for freemium platforms |
| **Spotlight algorithm** | Multi-objective ranking balancing engagement and creator monetization | Shows depth in recommendation system design |
| **Multicloud evolution** | Continued workload-aware placement achieving 65% cost reduction | Real-world case study for multicloud trade-offs |
...
7. **Mention My AI safety** - Shows awareness of LLM deployment challenges in consumer products
8. **Discuss multicloud economics** - Snap's 65% cost reduction is a compelling real-world case study
