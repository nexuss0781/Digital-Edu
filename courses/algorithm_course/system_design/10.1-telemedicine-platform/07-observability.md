...
Video Consultation Critical Path:
  ...
  Slowest part of the process:      ICE negotiation (200ms) — mitigated by ICE trickling
  Second Slowest part of the process: DTLS handshake (150ms) — mitigated by session resumption
```
