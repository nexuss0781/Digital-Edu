...
|-------------|--------|--------------------------|
| **Grok AI integration** | Native LLM integrated into timeline, search, and reply generation | On-platform inference cluster, latency budget for AI features alongside ranking |
| **Community Notes at scale** | Crowdsourced fact-checking with bridging-based algorithm | Separate scoring pipeline that must converge before note display; consensus latency |
| **Long-form content (Articles)** | Posts up to 25,000 characters for premium users | Content storage model changes, rendering pipeline adaptation, search indexing for long text |
| **Video-first strategy** | Vertical video feed competing with TikTok/Reels | New CDN optimization for video, separate recommendation pipeline for video content |
| **Infrastructure cost reduction** | Reported 60%+ reduction in cloud infrastructure spend | Service consolidation, cache tier optimization, reduced redundancy trade-offs |
| **Open-source algorithm updates** | Continued transparency into recommendation mechanics | Public scrutiny drives algorithm tuning toward measurable engagement metrics |
| **Premium subscription tiers** | Revenue model shift from ads to subscriptions | Priority ranking signals for subscribers, tiered API rate limits, verification status in scoring |
| **Decentralized social (Bluesky/AT Protocol)** | Competing protocol with portable identity | Pressure toward interoperability, open graph standards, data portability |

---

## Related Systems

- [Facebook](../4.1-facebook/00-index.md) - Bidirectional graph feed, contrasting fan-out thresholds (10K vs 100K)
- [Reddit](../4.11-reddit/00-index.md) - Community-based content ranking, hot/rising algorithms
- [Recommendation Engine](../3.12-recommendation-engine/00-index.md) - Multi-stage retrieval-scoring-ranking pipeline patterns
- [Content Delivery Network](../1.15-content-delivery-network-cdn/00-index.md) - Edge caching for media-heavy feeds and video delivery
- [Distributed Log-Based Broker](../1.5-distributed-log-based-broker/00-index.md) - Kafka-based event streaming for fan-out and search indexing
- [Distributed Rate Limiter](../1.1-distributed-rate-limiter/00-index.md) - Per-user and per-endpoint rate limiting at 300K QPS
- [RAG System](../3.15-rag-system/00-index.md) - Retrieval-augmented generation patterns used in Grok integration
- [AI Guardrails & Safety System](../3.22-ai-guardrails-safety-system/00-index.md) - Content moderation, Community Notes consensus algorithm

---

## References

- Twitter Engineering Blog - Recommendation Algorithm
- GitHub - twitter/the-algorithm (open-sourced)
- GitHub - twitter/the-algorithm-ml (open-sourced)
- Twitter Blog - Reducing Search Indexing Latency to 1 Second
- Twitter Blog - Stability and Scalability for Search
- High Scalability - Twitter Architecture Analysis
- MIT Research - Predicting Twitter Trending Topics
- Community Notes Guide - Bridging-based consensus algorithm
