...
### 3.1 Slowest part of the process: DNS Resolution for MX Records
...
### 3.2 Slowest part of the process: Suppression List Lookup at Scale
...
### 3.3 Slowest part of the process: SMTP Connection Overhead
...
### 3.4 Slowest part of the process: Webhook Delivery at Billions of Events
