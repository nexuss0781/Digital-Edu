...
```
┌────────────────────────────────────────────────────────────────────┐
│ INTELLIGENT TIERING: 5-TIER AUTOMATED MODEL                       │
├────────────────────────────────────────────────────────────────────┤
│                                                                     │
│ Problem: Manual lifecycle policies require predicting access       │
│ patterns. Prediction is often wrong, wasting money or degrading    │
│ performance.                                                       │
│                                                                     │
│ Solution: Monitor per-object access and transition automatically   │
│                                                                     │
│  Tier 1: Frequent Access (default)                                │
│  ├── Full Standard pricing                                        │
│  ├── Immediate access (< 50ms)                                    │
│  │                                                                 │
│  │ 30 days idle ↓                                                 │
│  │                                                                 │
...
│  │ 90 days idle ↓                                                 │
│  │                                                                 │
│  Tier 3: Archive Instant Access                                   │
│  ├── ~68% cost reduction                                          │
│  ├── Immediate access (milliseconds)                              │
│  │                                                                 │
│  │ 90+ days idle ↓ (opt-in)                                      │
│  │                                                                 │
│  Tier 4: Archive Access                                            │
│  ├── ~90% cost reduction                                          │
│  ├── 3-5 hour retrieval                                            │
│  │                                                                 │
│  │ 180+ days idle ↓ (opt-in)                                     │
│  │                                                                 │
│  Tier 5: Deep Archive Access                                       │
│  ├── ~95% cost reduction                                          │
│  └── 12-48 hour retrieval                                         │
│                                                                     │
│ Auto-promotion: Any access → return to Frequent Access            │
│ Exemption: Objects < 128 KB stay in Frequent Access (monitoring   │
│            cost would exceed savings)                              │
│                                                                     │
│ Real-world savings: ~67% cost reduction on mixed workloads        │
│                                                                     │
└────────────────────────────────────────────────────────────────────┘
```
...
| SSD + Intelligent Tiering | Good (auto-adaptive) | Medium-Low | Unknown access patterns |
