...
| Slowest part of the process | Cause | Detection | Mitigation |
|------------|-------|-----------|------------|
...
### Edge Case (Unusual or extreme situation): Slow Client Attack (Slowloris)
...
### Edge Case (Unusual or extreme situation): Upstream Connection Storm
...
### Edge Case (Unusual or extreme situation): HTTP/2 Stream Exhaustion
