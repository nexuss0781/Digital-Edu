...
5. **Integration scaling challenges**: With 200+ integration types and 15K+ organizations, the candidate should recognize that external system rate limits---not internal compute---are the fundamental Slowest part of the process, and design accordingly.
...
| At 30 min with no scalability | Full caching strategy | One Slowest part of the process (rate limits) with one mitigation |
