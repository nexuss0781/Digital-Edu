...
| **GPU Inference** | GPU-accelerated serving for deep learning models with memory sharing |
| **Model Mesh** | Heterogeneous model serving supporting classical ML and LLM workloads |

### 2025-2026 Extended Capabilities

| Capability | Description | Priority |
|------------|-------------|----------|
| **Vector Feature Support** | Embedding storage and similarity lookup for LLM-era features | P1 |
| **LLM Output Caching** | Cache expensive LLM inference outputs as derived features | P1 |
| **Prompt Feature Pipelines** | Declarative pipelines for generating and versioning prompt-based features | P2 |
| **GenAI Observability** | Hallucination diagnostics, prompt tracing, LLM judge integration | P2 |
| **Inference-Time Scaling** | Dynamic compute allocation shifting budget from training to serving | P1 |
...
| **Vector Features** | 0 | 5K | 25K | Dedicated vector index (ANN) |
| **GPU Pods** | 10 | 50 | 200 | Multi-GPU sharing, spot instances |
| **LLM Serving QPS** | 0 | 500 | 5K | Dedicated LLM serving cluster with KV-cache |

---

## Cross-System Dependencies

| Upstream System | Data Provided | Freshness | Impact if Unavailable |
|----------------|---------------|-----------|----------------------|
| **Booking Service** | Reservation events, cancellations | Real-time (Kafka) | Stale booking features, pricing inaccuracy |
| **Search Service** | Query logs, click events | Real-time (Kafka) | Search ranking features degrade |
| **User Service** | Profile data, preferences | Hourly batch | User personalization features stale |
| **Listing Service** | Listing attributes, availability | Real-time + batch | Listing features incorrect |
| **Payment Service** | Transaction data, fraud signals | Near-real-time | Pricing and fraud models impacted |
| **Experimentation Platform** | A/B test assignments | Real-time | Cannot measure model impact |
| **Data Lake** | Historical data for backfills | Batch (daily) | Training data generation blocked |
