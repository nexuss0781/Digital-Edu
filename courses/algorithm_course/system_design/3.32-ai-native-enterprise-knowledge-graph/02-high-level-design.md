...
| Component | Purpose | Key Responsibilities |
|-----------|---------|---------------------|
| **Local Search** | Entity-centric retrieval | Start from query entities, K-hop traversal, relevance Cutting off unnecessary steps |
...
flowchart LR
    ...
    subgraph Context["Context Assembly"]
        ...
        PRUNE["Token Budget Cutting off unnecessary steps"]
        CTX["Final Context"]
    end
