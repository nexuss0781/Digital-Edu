...
| **Subgraph Retrieval** | Retrieve relevant subgraphs for queries | K-hop traversal (K=1-4), relevance-based Cutting off unnecessary steps |
...
| K-hop traversal (K=4) | 100ms | 300ms | 500ms | Cutting off unnecessary steps applied |
...
| Entity resolution is sequential | Ingestion Slowest part of the process | Batch processing, parallelization |
...
| 100B relationships | Traversal latency | Cutting off unnecessary steps, caching hot paths |
