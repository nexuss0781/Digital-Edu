...
```
Slowest part of the process: Downstream bandwidth to each player
...
```
Slowest part of the process: Single-threaded tick simulation must complete within budget
...
```
Slowest part of the process: Encoding unique delta snapshots for 100 clients
...
```
Slowest part of the process: Sending 100 individual UDP packets per tick
