...
FUNCTION is_trace_complete(buffer) -> (complete: bool, confidence: float):
    // Practical rule of thumb 1: Root span completed
    ...
    // Practical rule of thumb 4: All parent_ids resolved
    ...
    // Practical rule of thumb 5: Root span duration matches child span total
...
### Slowest part of the process 1: Ingestion Backpressure
...
### Slowest part of the process 2: Query Performance on Large Time Ranges

**Symptom:** Dashboard queries timing out for 30-day views

**Root Causes:**
1. Scanning too much data (no partition Cutting off unnecessary steps)
...
| Partition Cutting off unnecessary steps | Ensure queries include partition key | Query complexity |
...
### Slowest part of the process 3: Evaluation Pipeline Latency
