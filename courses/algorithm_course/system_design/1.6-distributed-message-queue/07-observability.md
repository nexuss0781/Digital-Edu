...
### OpenTelemetry Messaging Semantic Conventions (v1.27+, 2025-2026)
...
├─────────────────────────────────────────────────────────────────┤
│                                                                  │
│  Stable Attributes (MUST set):                                   │
│  ┌─────────────────────────────────────────────────────────┐   │
│  │  messaging.system           = "rabbitmq"                │   │
│  │  messaging.operation.type   = "publish" | "receive"     │   │
│  │                               | "process"               │   │
│  │  messaging.destination.name = "order.process"           │   │
...
│                                                                  │
│  Consumer Metrics (OTel Messaging Metrics):                      │
│  • messaging.receive.duration   (histogram)                     │
│  • messaging.process.duration   (histogram)                     │
│  • messaging.receive.messages   (counter)                       │
│  • messaging.publish.messages   (counter)                       │
│                                                                  │
│  Key Change from Pre-1.27:                                       │
│  • messaging.destination_kind is DEPRECATED                     │
│  • messaging.operation replaces messaging.operation.name        │
│  • All messaging metrics now have stable semantic conventions   │
│                                                                  │
└─────────────────────────────────────────────────────────────────┘
```
