...
```
Step-by-step plan in plain English: Structured Log Format
...
```
Step-by-step plan in plain English: Trace Context Flow
...
```
Step-by-step plan in plain English: Service Health Check Hierarchy
