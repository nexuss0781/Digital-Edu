...
| **EU AI Act** | AI systems in EU market | Risk classification, transparency, human oversight, model documentation |
...
| **ISO 42001** | AI management systems | AI lifecycle governance, risk assessment, bias monitoring |

### EU AI Act Compliance (Effective 2025-2026)

The EU AI Act introduces requirements particularly relevant to model lifecycle management:

| Requirement | Runway Implementation |
|-------------|----------------------|
| **Risk Classification** | Model tier mapping (Tier 1-4) aligns with AI Act risk levels |
| **Technical Documentation** | Model cards with training data provenance, performance baselines, drift history |
| **Human Oversight** | Tier 1 approval workflows ensure human-in-the-loop for high-risk model changes |
| **Post-Market Monitoring** | Staleness detection and continuous performance tracking satisfy ongoing monitoring |
| **Transparency** | Explainability generator provides decision rationale for staleness and retrain triggers |
| **Data Governance** | Ground truth pipeline maintains data lineage from collection through aggregation |
| **Record Keeping** | Event-sourced audit trail preserves complete model state transition history |

```
AI ACT RISK MAPPING:

Runway Tier 1 → AI Act "High Risk" (personalization affecting content access)
  - Requires: Conformity assessment, technical documentation, post-market monitoring
  - Runway provides: Model cards, staleness SLAs, audit trails, human approval gates

Runway Tier 2 → AI Act "Limited Risk"
  - Requires: Transparency obligations
  - Runway provides: Model documentation, explainability reports

Runway Tier 3-4 → AI Act "Minimal Risk"
  - Requires: Voluntary codes of practice
  - Runway provides: Standard model cards, staleness monitoring
```
