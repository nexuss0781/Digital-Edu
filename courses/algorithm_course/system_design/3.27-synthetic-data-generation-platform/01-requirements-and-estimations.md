...
| Feature | Description | Key Capabilities |
|---------|-------------|------------------|
| **Conditional Generation** | Generate data matching specific constraints | Filter conditions (age > 65), Edge Case (Unusual or extreme situation) targeting, minority class oversampling |
