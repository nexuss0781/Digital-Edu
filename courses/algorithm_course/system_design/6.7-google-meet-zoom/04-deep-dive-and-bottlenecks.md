...
### Slowest part of the process 1: SFU Fan-Out Under High Participant Count
...
### Slowest part of the process 2: TURN Relay Server Bandwidth
...
TURN servers become a bandwidth and cost Slowest part of the process, especially for enterprise deployments behind corporate firewalls where TURN usage can reach 40-60%.
