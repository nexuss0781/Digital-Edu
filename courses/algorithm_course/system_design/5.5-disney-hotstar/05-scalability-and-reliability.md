...
CDN Provider A (Primary - 70%):
├─ Capacity: 56 Tbps
├─ India PoPs: 40+
├─ ISP partnerships: Major telecom carriers
└─ Cost: Premium but best India coverage

CDN Provider B (Backup - 20%):
├─ Capacity: 16 Tbps
├─ India PoPs: 10+
├─ Integration: Native cloud provider
└─ Cost: Moderate

CDN Provider C (Backup - 10%):
├─ Capacity: 8 Tbps
├─ India PoPs: 5+
