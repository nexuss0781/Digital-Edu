...
| [09 - Key Insights](./09-insights.md) | 13 non-obvious architectural insights |
...
| Infrastructure | 500+ cloud instances | During peak events |
...
| Design | Relationship |
|--------|--------------|
| [5.2 Netflix](../5.2-netflix/00-index.md) | VOD streaming architecture -- contrasts with live streaming's real-time constraints |
| [5.7 Twitch](../5.7-twitch/00-index.md) | Live streaming at scale -- shares low-latency delivery and chat infrastructure challenges |
| [5.1 YouTube](../5.1-youtube/00-index.md) | Video encoding pipeline and ABR strategy applicable to live ingest |
| [1.15 Content Delivery Network](../1.15-content-delivery-network-cdn/00-index.md) | Multi-CDN orchestration, edge caching, and origin shield patterns |
| [1.2 Distributed Load Balancer](../1.2-distributed-load-balancer/00-index.md) | L4/L7 load balancing for handling 20x traffic spikes |
| [1.4 Distributed LRU Cache](../1.4-distributed-lru-cache/00-index.md) | Cache warming, thundering herd mitigation, and request coalescing |
| [5.3 Netflix CDN](../5.3-netflix-cdn/00-index.md) | CDN architecture -- ISP-embedded appliances, traffic steering |
| [1.1 Distributed Rate Limiter](../1.1-distributed-rate-limiter/00-index.md) | Rate limiting strategies for protecting backend services during live event surges |
