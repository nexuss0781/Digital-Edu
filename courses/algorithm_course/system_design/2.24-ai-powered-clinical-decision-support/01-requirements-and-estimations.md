...
| **LLM-Based Chat Interface** | Out of scope; CDSS provides structured alerts, not conversational AI |
| **Social Determinants of Health** | Separate data pipeline; may inform risk scoring in future phase |

### Emerging Requirements (2025-2026)

| Feature | Description | Priority | Rationale |
|---------|-------------|----------|-----------|
| **LLM-Augmented Guideline Synthesis** | Use clinical foundation models to summarize relevant guidelines in natural language alongside CQL-based recommendations | P2 | Improves clinician comprehension; supplements structured alerts |
| **Multimodal Input Processing** | Accept unstructured clinical notes alongside structured FHIR data for diagnosis suggestions | P2 | Chief complaints are often free-text; NLP extraction improves diagnostic accuracy |
| **Real-World Evidence Feedback** | Capture treatment outcomes to validate and refine risk models using post-market surveillance data | P2 | EU AI Act post-market monitoring requirement; improves model accuracy over time |
| **Medication Administration Alerts** | Extend DDI checks to medication-administer CDS Hooks trigger (nursing workflow) | P1 | Catches last-line interaction at point of administration, not just prescribing |
| **Care Plan Integration** | Generate structured care plan suggestions based on guideline matches and risk scores | P2 | Bridges gap between alerting and actionable treatment planning |
| **Pharmacogenomic Readiness** | Design data model to accept genetic variant data (CYP2D6, CYP2C19) for future PGx-based dosing | P2 | Architectural investment; PGx certification planned for future phase |
