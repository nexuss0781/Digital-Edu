...
| LLM output fact-check pass rate | > 99% | < 98% |
| AI Act conformity status | Compliant | Any non-conformity |

---

## EU AI Act Enforcement Timeline & Compliance Roadmap

### Phased Enforcement Schedule

```
EU AI ACT ENFORCEMENT TIMELINE FOR CDSS:

2025-02-02: Prohibited AI practices & AI literacy obligations in effect
  Action: Verify no prohibited practices; AI literacy training for clinical staff

2025-08-02: GPAI model obligations + governance structures
  Action: Document LLM model cards; maintain technical documentation for any
          foundation models used in guideline synthesis

2026-08-02: FULL HIGH-RISK AI REQUIREMENTS IN EFFECT
  CDSS classified as HIGH-RISK under Annex III (medical devices)
  Mandatory requirements:
    Risk management system (Art. 9)
    Data governance framework (Art. 10)
    Technical documentation package (Art. 11)
    ...
    Conformity assessment via Notified Body (Art. 43)

2027-08-02: Obligations for AI in regulated products (Annex I)
  Action: Single Notified Body for combined MDR/AI Act assessment
```

### AI Act Article 14: Human Oversight Implementation

```
HUMAN OVERSIGHT LEVELS:

Level 1 - HUMAN-IN-THE-LOOP (All clinical alerts):
  Every AI output is a recommendation, never an autonomous action
  Clinician must actively accept or override
  No medication order can be auto-approved by AI

Level 2 - HUMAN-ON-THE-LOOP (Model governance):
  ML governance board reviews model changes quarterly
  Bias monitoring results reviewed monthly
  Adverse event reports trigger immediate human review

Level 3 - HUMAN-IN-COMMAND (System configuration):
  Alert thresholds require clinical lead approval
  Model deployment requires regulatory affairs sign-off
  System can be disabled immediately by designated roles
```

### Incident Reporting Under AI Act

| Incident Type | Reporting Deadline | Reporting Body | Internal Action |
|--------------|-------------------|----------------|-----------------|
| **Serious incident** (patient harm linked to AI) | 15 days | National market surveillance authority | Immediate model pause + investigation |
| **Systematic misuse** detected | 30 days | National authority | Access review + control tightening |
| **Material change** to high-risk AI system | Before deployment | Notified Body | Conformity re-assessment |
| **Substantial modification** to intended purpose | Before deployment | Notified Body | New conformity assessment required |
