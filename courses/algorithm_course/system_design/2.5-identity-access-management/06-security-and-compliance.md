...
flowchart TB
    subgraph External["External Threats"]
        Attacker[Attacker]
        BruteForce[Brute Force (Checking every single possibility)]
...
|--------|--------|------------|------------|
| **Brute Force (Checking every single possibility)** | Account takeover | High | Rate limiting, account lockout, CAPTCHA |
...
### Brute Force (Checking every single possibility) Protection

```
CLASS BruteForceProtection:
    """
    Multi-layer Brute Force (Checking every single possibility) protection.
    """
