...
// Failed login (Brute Force (Checking every single possibility) detected)
{
...
ALERTS:
    ...
    brute_force_attack:
        ...
        for: 2m
        severity: critical
        summary: "Possible Brute Force (Checking every single possibility) attack detected"
...
PANELS:
    ...
    Row 2 - Authentication Security:
        ...
        - Brute Force (Checking every single possibility) Attempts (time series)
