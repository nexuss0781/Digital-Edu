...
| **Slowest part of the process** | Channel Server memory | Guild Process throughput |
...
### Slowest part of the process 1: Hot Channels/Guilds
...
- Guild Process becomes CPU Slowest part of the process
...
### Slowest part of the process 2: Presence Storms
...
### Slowest part of the process 3: Search at Scale
...
### Slowest part of the process 4: Database Hot Partitions (Discord)
