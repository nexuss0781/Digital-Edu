...
|--------|-------------|--------------|
| [WhatsApp](../4.7-whatsapp/) | Messaging at scale with BEAM runtime | E2EE trade-offs vs server-side search; Erlang process-per-connection mirrors Discord GenServer model |
| [Telegram](../4.9-telegram/) | Large-channel fanout, broadcast channels | Pointer-based fanout for 43M-subscriber channels; PTS/QTS state model for multi-device sync |
| [Google Meet/Zoom](../6.7-google-meet-zoom/) | Voice/video infrastructure | SFU vs MCU trade-offs; Discord huddles/voice channels share WebRTC patterns |
| [WebRTC Collaborative Canvas](../6.11-webrtc-collaborative-canvas/) | Real-time WebRTC signaling | CRDT-based conflict resolution; signaling server patterns applicable to voice channel negotiation |
| [Push Notification System](../11.3-push-notification-system/) | Offline user notification delivery | APNs/FCM integration patterns; notification deduplication and batching strategies |
| [Consistent Hashing Ring](../1.9-consistent-hashing-ring/) | Core routing primitive | Slack's Channel Server routing uses consistent hashing with 150 virtual nodes |
| [Distributed Log-Based Broker](../1.5-distributed-log-based-broker/) | Event streaming backbone | Message ordering guarantees; partition-based parallelism mirrors channel-based sharding |
| [Twitch](../5.7-twitch/) | Large-audience real-time delivery | Chat fanout to millions of concurrent viewers; similar hot-channel challenges |
