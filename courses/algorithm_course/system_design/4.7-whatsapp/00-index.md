...
| Design | Relevance |
|--------|-----------|
| [4.8 - Snapchat](../4.8-snapchat/00-index.md) | Ephemeral messaging patterns, media encryption |
| [4.9 - Telegram](../4.9-telegram/00-index.md) | Alternative messaging architecture, server-side history |
| [4.10 - Slack/Discord](../4.10-slack-discord/00-index.md) | Channel-based messaging, workspace persistence |
| [1.5 - Distributed Log-Based Broker](../1.5-distributed-log-based-broker/00-index.md) | Message queue patterns, store-and-forward |
| [1.4 - Distributed LRU Cache](../1.4-distributed-lru-cache/00-index.md) | Presence caching, connection state |
| [2.10 - Zero Trust Security](../2.10-zero-trust-security-architecture/00-index.md) | Security architecture, mutual TLS |
| [1.6 - Distributed Message Queue](../1.6-distributed-message-queue/00-index.md) | Offline queue semantics, delivery guarantees |
| [11.3 - Push Notification System](../11.3-push-notification-system/00-index.md) | APNs/FCM integration for offline delivery |
