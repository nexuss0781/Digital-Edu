...
| Infrastructure CapEx 2026 | $115-135 billion | Financial reports |
| GPUs Deployed | 1.3 million+ | NVIDIA partnership announcement |
| Feed Ranking Models | 100+ prediction models | Transparency Center |
| Unconnected Content in Feed | Up to 50% | Algorithm disclosure |
| Data Center Capacity Target | 10+ GW by late 2026 | Infrastructure roadmap |
...
|-------------|--------|--------------------------|
| **50% unconnected content in feed** | Feed is now a hybrid social + recommendation system | Requires embedding-based retrieval alongside social graph fan-out |
| **100+ ranking models per feed request** | Dramatically higher inference compute per request | GPU fleet scaled to 1.3M+; custom inference accelerators |
| **UTIS survey-based ranking calibration** | Ground-truth satisfaction signal alongside engagement | Separate survey infrastructure and satisfaction model training pipeline |
| **AI content moderation replacing human reviewers** | LLMs exceed human performance in select policy areas | Inline moderation pipeline with separate deployment cadence from ranking |
| **$115-135B annual infrastructure spend** | Scale beyond traditional data center design | Campus-level architecture; 2-5 GW single-site facilities |
| **Same-day Reels prioritization** | 50% more same-day Reels surfaced; freshness-weighted ranking | Tighter content ingestion-to-serving pipeline; reduced ranking latency budgets |
...
| [Content Delivery Network](../1.15-content-delivery-network-cdn/00-index.md) | Media delivery, edge caching patterns |
| [Feature Store](../3.16-feature-store/00-index.md) | ML feature serving for ranking pipeline |
| [Instagram](../4.3-instagram/00-index.md) | Shared infrastructure (TAO, CDN), Stories architecture |
