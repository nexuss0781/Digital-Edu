...
The **heap property** is a simple Rule that never changes that must be maintained:
...
**Time Complexity (Speed of the algorithm)**: O(N log K) where N is total elements and K is number of lists.
