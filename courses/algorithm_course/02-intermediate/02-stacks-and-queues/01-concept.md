...
## Stack: Last In, First Out (LIFO (Last-In-First-Out, like a stack of plates))
...
| Operation | Description | Time Complexity (Speed of the algorithm) |
|-----------|-------------|-----------------|
...
## Queue: First In, First Out (FIFO (First-In-First-Out, like a line at a store))
...
### Priority Queue
Queue where elements have priorities, not FIFO (First-In-First-Out, like a line at a store) order.
