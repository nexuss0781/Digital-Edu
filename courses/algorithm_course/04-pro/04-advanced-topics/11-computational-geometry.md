...
| **Time Complexity (Speed of the algorithm)** | O(n log n) for most algorithms using sorting/divide-conquer |
| **Space Complexity (Memory usage of the algorithm)** | O(n) typically |
