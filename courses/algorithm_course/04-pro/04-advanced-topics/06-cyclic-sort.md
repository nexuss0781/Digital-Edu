...
| **Time Complexity (Speed of the algorithm)** | O(n) - each element moved at most once |
| **Space Complexity (Memory usage of the algorithm)** | O(1) - in-place sorting |
...
- You need O(1) Space Complexity (Memory usage of the algorithm)
...
## Why O(n) Time Complexity (Speed of the algorithm)?
