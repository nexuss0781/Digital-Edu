...
| **Time Complexity (Speed of the algorithm)** | O(n log n) due to sorting, O(n) for merging |
| **Space Complexity (Memory usage of the algorithm)** | O(n) for storing merged result |
