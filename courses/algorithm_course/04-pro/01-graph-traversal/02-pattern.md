...
| **Time Complexity (Speed of the algorithm)** | O(V + E) for both BFS and DFS |
| **Space Complexity (Memory usage of the algorithm)** | O(V) for visited set and queue/stack |
...
**First Principle:** BFS uses a queue (FIFO (First-In-First-Out, like a line at a store)) to ensure level-by-level exploration. DFS uses a stack (LIFO (Last-In-First-Out, like a stack of plates)) or recursion to dive deep first. Both ensure each node is visited exactly once.
...
| **Data Structure** | Queue (FIFO (First-In-First-Out, like a line at a store)) | Stack (LIFO (Last-In-First-Out, like a stack of plates)) or recursion |
| **Shortest Path** | ✅ Yes (unweighted graphs) | ❌ No |
| **Space Complexity (Memory usage of the algorithm)** | O(w) width of graph | O(h) height of graph |
...
def bfs(graph, start):
    ...
    while queue:
        node = queue.popleft()  # FIFO (First-In-First-Out, like a line at a store): first in, first out
...
### BFS: Time and Space Complexity (Memory usage of the algorithm)

- **Time Complexity (Speed of the algorithm)**: O(V + E)
  - V = number of vertices
  - E = number of edges
  - Visit each vertex once, explore each edge once

- **Space Complexity (Memory usage of the algorithm)**: O(V)
...
def dfs_iterative(graph, start):
    ...
    while stack:
        node = stack.pop()  # LIFO (Last-In-First-Out, like a stack of plates): last in, first out
...
### DFS: Time and Space Complexity (Memory usage of the algorithm)

- **Time Complexity (Speed of the algorithm)**: O(V + E)
  - Same as BFS: visit each vertex once, explore each edge once

- **Space Complexity (Memory usage of the algorithm)**: O(h)
...
| **Backtracking** | Need all solutions with Cutting off unnecessary steps |
...
| Aspect | BFS | DFS |
|--------|-----|-----|
| **Data Structure** | Queue (FIFO (First-In-First-Out, like a line at a store)) | Stack/Recursion (LIFO (Last-In-First-Out, like a stack of plates)) |
...
Both BFS and DFS are fundamental graph algorithms with O(V + E) Time Complexity (Speed of the algorithm). Choose based on your problem requirements: BFS for shortest paths, DFS for deep exploration and cycle detection. Master both patterns to tackle any graph problem efficiently.
