...
### Edge Case (Unusual or extreme situation) 1: No Prerequisites
...
### Edge Case (Unusual or extreme situation) 2: Linear Chain
...
### Edge Case (Unusual or extreme situation) 3: Self-Loop
...
>
> Time Complexity (Speed of the algorithm) is O(V + E) where V is courses and E is prerequisites - we visit each node and edge once. Space is O(V + E) for the graph plus recursion stack.
>
