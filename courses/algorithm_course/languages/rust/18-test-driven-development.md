...
- [Test-Driven Development in Rust](#test-driven-development-in-rust)
  ...
  - [Thinking Like a QA Engineer](#thinking-like-a-qa-engineer)
    ...
    - [Edge Case (Unusual or extreme situation) Hunting Techniques](#edge-case-hunting-techniques)
...
### Edge Case (Unusual or extreme situation) Hunting Techniques
...
5. **Add related Edge Case (Unusual or extreme situation) tests**
...
#[test]
#[should_panic(expected = "Rule that never changes violated")]
