...
def combine(n: int, k: int) -> list[list[int]]:
    ...
    def backtrack(start, path):
        ...
        # Cutting off unnecessary steps: need k - len(path) more elements
...
### Use When
- Optimal substructure (Best possible solution built from optimal subproblems)
- Overlapping subproblems (same subproblems solved multiple times)
- Counting ways or finding min/max

### Pattern: Top-Down (Memoization (Saving results to avoid repeating work))
...
### Pattern: Bottom-Up (Tabulation (Building a table of results from the bottom up))
...
| Pattern | Signal Keywords | Time Complexity (Speed of the algorithm) |
|---------|-----------------|-----------------|
