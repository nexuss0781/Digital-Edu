...
### Edge Case (Unusual or extreme situation) Hunting
...
- **Edge Case (Unusual or extreme situation) hunting**: Test boundaries, limits, empty inputs
...
- [Edge Case (Unusual or extreme situation) Testing Guide](https://www.applause.com/blog/how-to-find-test-edge-cases/)
