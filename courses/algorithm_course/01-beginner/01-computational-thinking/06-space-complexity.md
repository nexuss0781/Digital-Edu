---
title: "Understanding Space Complexity (Memory usage of the algorithm): A Beginner's Guide"
...
# Understanding Space Complexity (Memory usage of the algorithm)

## What is Space Complexity (Memory usage of the algorithm)?
...
**Space Complexity (Memory usage of the algorithm)** measures how much memory an algorithm needs as the input size grows. Just like Time Complexity (Speed of the algorithm) uses Big O notation, so does Space Complexity (Memory usage of the algorithm).
...
# Space Complexity (Memory usage of the algorithm): O(n) - we made a copy of size n
```

**Important**: When people say "Space Complexity (Memory usage of the algorithm)", they usually mean **auxiliary space** - the extra memory you create.
...
# Space Complexity (Memory usage of the algorithm): O(n) - the answer we give
```

**Key Point**: We typically report **auxiliary space** when discussing Space Complexity (Memory usage of the algorithm), because the input space is already "spent" before our algorithm runs.
...
# Space Complexity (Memory usage of the algorithm): O(n) - stack depth equals n
```
...
# Both have same Time Complexity (Speed of the algorithm) O(n)
# But different Space Complexity (Memory usage of the algorithm)!
```
...
## How to Analyze Space Complexity (Memory usage of the algorithm) Step by Step
...
## Common Patterns and Their Space Complexity (Memory usage of the algorithm)
...
## Visual: Space Complexity (Memory usage of the algorithm) Decision Tree

```mermaid
graph TD
    Start[Analyzing Space Complexity (Memory usage of the algorithm)]
...
What is the Space Complexity (Memory usage of the algorithm)?
...
How can you reduce the Space Complexity (Memory usage of the algorithm) of this function?
...
1. **Space Complexity (Memory usage of the algorithm) measures extra memory used**, not including the input
...
Remember: The "best" algorithm depends on your specific constraints and requirements. Understanding both time and Space Complexity (Memory usage of the algorithm) helps you make informed decisions!
