...
3. Write Step-by-step plan in plain English
   └─ Express the solution in plain language

4. Implement in code
   └─ Translate Step-by-step plan in plain English to programming language
...
**Algorithm (Step-by-step plan in plain English)**:
```
...
Try writing Step-by-step plan in plain English algorithms for these:
...
4. Write Step-by-step plan in plain English algorithm
...
- Write Step-by-step plan in plain English first
- Then implement
...
2. Learn [Time Complexity (Speed of the algorithm)](./time-complexity.md) to evaluate algorithm efficiency
