...
**Time Complexity (Speed of the algorithm):** O(√n) — checking 1,000 numbers instead of 1,000,000 for n = 10⁶
...
**Time Complexity (Speed of the algorithm):** O(n log log n) — nearly linear
...
**Time Complexity (Speed of the algorithm):** O(log n) — exponentially faster than naive approach
