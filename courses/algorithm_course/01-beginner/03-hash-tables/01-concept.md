...
**Key Insight:** Hash tables trade space for time. They use extra memory to achieve near-Constant Time (Same time regardless of data size) operations.
...
### Pattern 4: Caching/Memoization (Saving results to avoid repeating work)
...
- ✅ Caching/Memoization (Saving results to avoid repeating work)
...
| Need | Structure | Time Complexity (Speed of the algorithm) |
|------|-----------|----------------|
