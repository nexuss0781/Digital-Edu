---
id: rwd/lab-travel-agency-page/669e2f60e83c011754f711f9
...
1. The three anchor elements should have an `img` element with an appropriate `alt` attribute and a `src` attribute set to a valid image as their content. You can use `../assets/colosseo.jpg`, `../assets/alps.jpg`, and `../assets/sea.jpg` if you would like.
