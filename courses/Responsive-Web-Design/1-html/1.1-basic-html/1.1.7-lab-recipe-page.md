---
id: rwd/lab-recipe-page/668f08ea07b99b1f4a91acab
...
1. You should have one `img` element with a `src` attribute set to a valid image and an `alt` attribute describing the image. You can use `../assets/recipe.jpg` if you would like.
...
<body>
  ...
  <img src="../assets/recipe.jpg" alt="Ingredients for baking: three eggs, a bowl of flour, a glass of milk, and a whisk arranged on a wooden table.">
  <h2>Ingredients</h2>
  <ul>
