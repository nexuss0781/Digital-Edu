---
id: rwd/lab-blog-post-card/66eaddd04a9e533fba689001
...
2. Within the `.blog-post-card` element, you should have an image element with a valid `alt` attribute and text, and a class of `post-img`. You can use `../assets/cover-photo.jpg` for the `src` attribute of the image.
...
<body>
    <div class="blog-post-card">
        <img src="../assets/cover-photo.jpg" alt="Blog Post Image" class="post-img">
