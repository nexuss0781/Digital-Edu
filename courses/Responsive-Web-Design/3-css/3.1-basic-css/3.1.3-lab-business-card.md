---
id: rwd/lab-business-card/6690e10ebe2181212abc9652
...
1. Inside the `.business-card` element, there should be an `img` element with a `class` attribute with a value of `profile-image`. You can set the image source to `../assets/flower.jpg` if you like. There should be an `alt` with a meaningful description.
...
<body>
    <div class="business-card">
        <img src="../assets/flower.jpg" alt="A vibrant flower in full bloom" class="profile-image">
